...
static void init_globals(void) {
  w2c_g0 = 8192u;
  w2c___heap_base = 17528u;
  w2c___data_end = 17528u;
}
...
static void w2c_f46(u32 w2c_p0, u64 w2c_p1, u64 w2c_p2, u32 w2c_p3, u32 w2c_p4) {
  u32 w2c_l5 = 0, w2c_l8 = 0, w2c_l11 = 0;
  u64 w2c_l6 = 0, w2c_l7 = 0, w2c_l9 = 0, w2c_l10 = 0;
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1, w2c_i2, w2c_i3;
  u64 w2c_j0, w2c_j1, w2c_j2, w2c_j3;
  w2c_i0 = w2c_g0;
...
static u32 w2c__Znwj(u32 w2c_p0) {
  ...
  w2c_L1: 
    ...
    w2c_p0 = w2c_i0;
    w2c_i0 = 0u;
    w2c_i0 = i32_load((&w2c_memory), (u64)(w2c_i0) + 9120u);
    w2c_l2 = w2c_i0;
    w2c_i0 = !(w2c_i0);
    if (w2c_i0) {goto w2c_B0;}
    w2c_i0 = w2c_l2;
...
static u32 w2c_f78(u32 w2c_p0) {
  ...
  w2c_l1 = w2c_i0;
  w2c_i0 = 0u;
  w2c_i0 = i32_load8_u((&w2c_memory), (u64)(w2c_i0) + 9124u);
  w2c_i0 = !(w2c_i0);
  if (w2c_i0) {goto w2c_B1;}
  w2c_i0 = 0u;
  ...
  w2c_i0 = 0u;
  w2c_i1 = 1u;
  i32_store8((&w2c_memory), (u64)(w2c_i0) + 9124, w2c_i1);
  w2c_i0 = 0u;
  w2c_i1 = w2c_l2;
  w2c_i2 = 16u;
  w2c_i1 <<= (w2c_i2 & 31);
  w2c_l2 = w2c_i1;
  i32_store((&w2c_memory), (u64)(w2c_i0) + 9128, w2c_i1);
  w2c_B0:;
  w2c_i0 = w2c_l2;
  w2c_l3 = w2c_i0;
  w2c_i0 = w2c_l2;
...
static void w2c_f79(u32 w2c_p0) {
  ...
  if (w2c_i0) {goto w2c_B1;}
  w2c_i0 = 0u;
  w2c_i0 = i32_load((&w2c_memory), (u64)(w2c_i0) + 17516u);
  w2c_l1 = w2c_i0;
  w2c_i1 = 1u;
  w2c_i0 = (u32)((s32)w2c_i0 < (s32)w2c_i1);
  if (w2c_i0) {goto w2c_B1;}
...
static const u8 data_segment_data_1[] = {
  0x67, 0x65, 0x6d, 0x63, 0x69, 0x74, 0x79, 0x6c, 0x69, 0x6d, 0x69, 0x74, 
  0x00, 
};
...
static void init_memory(void) {
  ...
  memcpy(&(w2c_memory.data[8310u]), data_segment_data_2, 24);
  memcpy(&(w2c_memory.data[8334u]), data_segment_data_3, 64);
  memcpy(&(w2c_memory.data[8398u]), data_segment_data_4, 51);
  memcpy(&(w2c_memory.data[8449u]), data_segment_data_5, 23);
  memcpy(&(w2c_memory.data[8472u]), data_segment_data_6, 49);
  memcpy(&(w2c_memory.data[8521u]), data_segment_data_7, 20);
  memcpy(&(w2c_memory.data[8541u]), data_segment_data_8, 5);
  memcpy(&(w2c_memory.data[8546u]), data_segment_data_9, 51);
  memcpy(&(w2c_memory.data[8597u]), data_segment_data_10, 6);
  memcpy(&(w2c_memory.data[8603u]), data_segment_data_11, 46);
  memcpy(&(w2c_memory.data[8649u]), data_segment_data_12, 51);
  memcpy(&(w2c_memory.data[8700u]), data_segment_data_13, 59);
  memcpy(&(w2c_memory.data[8759u]), data_segment_data_14, 43);
  memcpy(&(w2c_memory.data[8802u]), data_segment_data_15, 19);
  memcpy(&(w2c_memory.data[8821u]), data_segment_data_16, 18);
  memcpy(&(w2c_memory.data[8839u]), data_segment_data_17, 45);
  memcpy(&(w2c_memory.data[8884u]), data_segment_data_18, 50);
  memcpy(&(w2c_memory.data[8934u]), data_segment_data_19, 53);
  memcpy(&(w2c_memory.data[8987u]), data_segment_data_20, 48);
  memcpy(&(w2c_memory.data[9035u]), data_segment_data_21, 22);
  memcpy(&(w2c_memory.data[9057u]), data_segment_data_22, 21);
  memcpy(&(w2c_memory.data[9078u]), data_segment_data_23, 35);
  memcpy(&(w2c_memory.data[9113u]), data_segment_data_24, 4);
}
