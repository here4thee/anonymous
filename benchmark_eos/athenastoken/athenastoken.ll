; ModuleID = 'athenastoken.cpp'
source_filename = "athenastoken.cpp"
...
%"struct.std::__1::__compressed_pair_elem.34" = type { %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* }
...
%"struct.std::__1::__compressed_pair_elem.38" = type { %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* }
...
%"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr" = type <{ %"class.std::__1::unique_ptr.36", [4 x i8], i64, i32, [4 x i8] }>
...
%class.anon.253 = type { %"class.eosio::token"*, { i32, i32 }* }
...
$_ZN5eosio14execute_actionINS_5tokenEJNS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEEEEbNS_4nameESA_MT_FvDpT0_E = comdat any
...
$_ZN5boost4mp116detail16tuple_apply_implIRZN5eosio14execute_actionINS3_5tokenEJNS3_5assetENSt3__112basic_stringIcNS7_11char_traitsIcEENS7_9allocatorIcEEEEEEEbNS3_4nameESE_MT_FvDpT0_EEUlDpT_E_RNS7_5tupleIJS6_SD_EEEJLj0ELj1EEEEDTclclsr3stdE7forwardISF_Efp_Espclsr3stdE3getIXT1_EEclsr3stdE7forwardIT0_Efp0_EEEEOSF_OSR_NS0_16integer_sequenceIjJXspT1_EEEE = comdat any
...
@.str.7 = private unnamed_addr constant [51 x i8] c"cannot create objects in table of another contract\00", align 1
@.str.8 = private unnamed_addr constant [6 x i8] c"write\00", align 1
@.str.9 = private unnamed_addr constant [46 x i8] c"object passed to modify is not in multi_index\00", align 1
@.str.10 = private unnamed_addr constant [51 x i8] c"cannot modify objects in table of another contract\00", align 1
@.str.11 = private unnamed_addr constant [59 x i8] c"updater cannot change primary key when modifying an object\00", align 1
@.str.12 = private unnamed_addr constant [43 x i8] c"attempt to add asset with different symbol\00", align 1
@.str.13 = private unnamed_addr constant [19 x i8] c"addition underflow\00", align 1
@.str.14 = private unnamed_addr constant [18 x i8] c"addition overflow\00", align 1
@.str.15 = private unnamed_addr constant [48 x i8] c"attempt to subtract asset with different symbol\00", align 1
@.str.16 = private unnamed_addr constant [22 x i8] c"subtraction underflow\00", align 1
@.str.17 = private unnamed_addr constant [21 x i8] c"subtraction overflow\00", align 1
...
define hidden void @_ZN5eosio5token6createENS_4nameENS_5assetE(%"class.eosio::token"* nocapture readonly, i64, %"struct.eosio::asset"* byval align 8) #0 {
  ...
  tail call void @require_auth(i64 %13) #9
  ...
  %25 = tail call i32 @db_find_i64(i64 %17, i64 %18, i64 -4157508551318700032, i64 %18) #9, !noalias !19
  %26 = icmp slt i32 %25, 0
  br i1 %26, label %35, label %27

; <label>:27:                                     ; preds = %3
  %28 = call dereferenceable(56) %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index"* nonnull %11, i32 %25) #9, !noalias !19
...
; <label>:34:                                     ; preds = %27
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !25
  br label %35

; <label>:35:                                     ; preds = %27, %34, %3
  %36 = load i64, i64* %12, align 8
  %37 = call i64 @current_receiver() #9, !noalias !28
  %38 = load i64, i64* %19, align 8, !tbaa !31, !noalias !28
  %39 = icmp eq i64 %38, %37
  br i1 %39, label %41, label %40

; <label>:40:                                     ; preds = %35
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.7, i32 0, i32 0)) #9, !noalias !28
  br label %41

; <label>:41:                                     ; preds = %40, %35
  %42 = bitcast %"class.std::__1::unique_ptr"* %8 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %42) #10, !noalias !28
  %43 = ptrtoint %"class.eosio::multi_index"* %11 to i32
  %44 = call i8* @_Znwj(i32 56) #11, !noalias !32
  ...
  call void @llvm.lifetime.start.p0i8(i64 40, i8* nonnull %53) #10, !noalias !32
  store i64 %15, i64* %47, align 8, !tbaa !2, !noalias !32
  %54 = bitcast %"struct.eosio::asset"* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %48, i8* nonnull align 8 %54, i32 16, i1 false) #10, !tbaa.struct !38, !noalias !32
  store i64 %1, i64* %50, align 8, !tbaa !2, !noalias !32
  %55 = bitcast %"class.eosio::datastream.79"* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %55) #10, !noalias !32
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %61) #10, !noalias !32
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %63) #10, !noalias !32
...
; <label>:83:                                     ; preds = %81, %41
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %55) #10, !noalias !32
  call void @llvm.lifetime.end.p0i8(i64 40, i8* nonnull %53) #10, !noalias !32
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %86) #10, !noalias !28
  %87 = load i64, i64* %47, align 8, !tbaa !55, !noalias !28
  %88 = lshr i64 %87, 8
  store i64 %88, i64* %9, align 8, !tbaa !2, !noalias !28
  %89 = bitcast i32* %10 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %89) #10, !noalias !28
...
; <label>:98:                                     ; preds = %83
  ...
  call void @_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS7_4itemENS_14default_deleteISE_EEEERyRiEEEvDpOT_(%"class.std::__1::vector"* nonnull %99, %"class.std::__1::unique_ptr"* nonnull dereferenceable(4) %8, i64* nonnull dereferenceable(8) %9, i32* nonnull dereferenceable(4) %10) #9, !noalias !28
  br label %100

; <label>:100:                                    ; preds = %98, %93
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %89) #10, !noalias !28
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %86) #10, !noalias !28
...
; <label>:103:                                    ; preds = %100
  ...
  call void @_ZdlPv(i8* %104) #11, !noalias !28
  br label %105

; <label>:105:                                    ; preds = %100, %103
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %42) #10, !noalias !28
...
define hidden void @_ZN5eosio5token5issueENS_4nameENS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEE(%"class.eosio::token"* nocapture readonly, i64, %"struct.eosio::asset"* byval align 8, %"class.std::__1::basic_string"*) #0 {
  ...
  %24 = tail call i32 @db_find_i64(i64 %16, i64 %17, i64 -4157508551318700032, i64 %17) #9, !noalias !66
  %25 = icmp slt i32 %24, 0
  br i1 %25, label %34, label %26

; <label>:26:                                     ; preds = %4
  %27 = call dereferenceable(56) %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index"* nonnull %7, i32 %24) #9, !noalias !66
...
; <label>:33:                                     ; preds = %26
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !69
  br label %34
...
; <label>:34:                                     ; preds = %4, %26, %33
  ...
  call void @require_auth(i64 %38) #9
  ...
  call void @_ZN5eosio5token11add_balanceENS_4nameENS_5assetES1_(%"class.eosio::token"* nonnull %0, i64 %41, %"struct.eosio::asset"* byval nonnull align 8 %9, i64 %41) #12
...
; <label>:46:                                     ; preds = %34
  ...
  %51 = call i8* @_Znwj(i32 16) #11
  %52 = getelementptr inbounds i8, i8* %51, i32 16
  %53 = bitcast [1 x %"struct.eosio::permission_level"]* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 8 %51, i8* nonnull align 8 %53, i32 16, i1 false) #10, !tbaa.struct !38
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %59, i8* nonnull align 8 %43, i32 16, i1 false) #10, !tbaa.struct !38
  %60 = getelementptr inbounds %"class.std::__1::tuple", %"class.std::__1::tuple"* %11, i32 0, i32 0, i32 3, i32 0
  %61 = call %"class.std::__1::basic_string"* @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC1ERKS5_(%"class.std::__1::basic_string"* nonnull %60, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %3) #9
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %78, i8* nonnull align 8 %59, i32 16, i1 false) #10, !tbaa.struct !38
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %81, i8* nonnull align 8 %82, i32 12, i1 false) #10
  ...
  call void @_ZN5eosio15dispatch_inlineIJNS_4nameES1_NS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEEEEvS1_S1_NS3_6vectorINS_16permission_levelENS7_ISB_EEEENS3_5tupleIJDpT_EEE(i64 %47, i64 -3617168760277827584, %"class.std::__1::vector.8"* nonnull %5, %"class.std::__1::tuple"* nonnull %6) #9
...
; <label>:12:                                     ; preds = %3
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.9, i32 0, i32 0)) #9
  br label %13
...
; <label>:18:                                     ; preds = %13
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.10, i32 0, i32 0)) #9
  br label %19
...
; <label>:28:                                     ; preds = %19
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.12, i32 0, i32 0)) #9
  br label %29
...
; <label>:36:                                     ; preds = %29
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.13, i32 0, i32 0)) #9
...
; <label>:41:                                     ; preds = %38
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.14, i32 0, i32 0)) #9
  br label %42
...
; <label>:46:                                     ; preds = %42
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.11, i32 0, i32 0)) #9
  br label %47
...
; <label>:47:                                     ; preds = %46, %42
  ...
  call void @_ZN5boost3pfr6detail19for_each_field_implINS1_14sequence_tuple5tupleIJRKN5eosio5assetES8_RKNS5_4nameEEEEZNS5_lsINS5_10datastreamIPcEENS5_5token14currency_statsELPv0EEERT_SL_RKT0_EUlRKSK_E_JLj0ELj1ELj2EEEEvSL_OSM_NSt3__116integer_sequenceIjJXspT1_EEEENST_17integral_constantIbLb0EEE(%"struct.boost::pfr::detail::sequence_tuple::tuple.84"* nonnull dereferenceable(12) %4, %class.anon.98* nonnull dereferenceable(4) %69) #9
  ...
  call void @db_update_i64(i32 %71, i64 0, i8* nonnull %49, i32 40) #9
...
define hidden void @_ZN5eosio5token11add_balanceENS_4nameENS_5assetES1_(%"class.eosio::token"* nocapture readonly, i64, %"struct.eosio::asset"* byval align 8, i64) local_unnamed_addr #0 {
  ...
  %23 = lshr i64 %22, 8
  %24 = tail call i32 @db_find_i64(i64 %14, i64 %1, i64 3607749779137757184, i64 %23) #9, !noalias !100
  %25 = icmp slt i32 %24, 0
  br i1 %25, label %34, label %26

; <label>:26:                                     ; preds = %4
  %27 = call dereferenceable(32) %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index.19"* nonnull %10, i32 %24) #9, !noalias !100
...
; <label>:33:                                     ; preds = %26
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !105
  br label %88

; <label>:34:                                     ; preds = %4
  %35 = call i64 @current_receiver() #9, !noalias !108
  %36 = load i64, i64* %15, align 8, !tbaa !31, !noalias !108
  %37 = icmp eq i64 %36, %35
  br i1 %37, label %39, label %38

; <label>:38:                                     ; preds = %34
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.7, i32 0, i32 0)) #9, !noalias !108
  br label %39

; <label>:39:                                     ; preds = %38, %34
  %40 = bitcast %"class.std::__1::unique_ptr.36"* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %40) #10, !noalias !108
  %41 = ptrtoint %"class.eosio::multi_index.19"* %10 to i32
  %42 = call i8* @_Znwj(i32 32) #11, !noalias !111
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %47) #10, !noalias !111
  %48 = bitcast %"struct.eosio::asset"* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %42, i8* nonnull align 8 %48, i32 16, i1 false) #10, !tbaa.struct !38, !noalias !111
  %49 = call i8* @memcpy(i8* nonnull %47, i8* nonnull %42, i32 8) #9, !noalias !111
  %50 = getelementptr inbounds [16 x i8], [16 x i8]* %6, i32 0, i32 8
  %51 = load i64, i64* %44, align 8, !noalias !111
  %52 = bitcast i64* %5 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %52) #10, !noalias !111
  store i64 %51, i64* %5, align 8, !tbaa !2, !noalias !111
  %53 = call i8* @memcpy(i8* nonnull %50, i8* nonnull %52, i32 8) #9, !noalias !111
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %52) #10, !noalias !111
  %54 = load i64, i64* %44, align 8, !tbaa !55, !noalias !111
  %55 = lshr i64 %54, 8
  %56 = load i64, i64* %16, align 8, !tbaa !90, !noalias !111
  %57 = call i32 @db_store_i64(i64 %56, i64 3607749779137757184, i64 %3, i64 %55, i8* nonnull %47, i32 16) #9, !noalias !111
...
; <label>:64:                                     ; preds = %62, %39
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %47) #10, !noalias !111
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %68) #10, !noalias !108
  %69 = load i64, i64* %44, align 8, !tbaa !55, !noalias !108
  %70 = lshr i64 %69, 8
  store i64 %70, i64* %8, align 8, !tbaa !2, !noalias !108
  %71 = bitcast i32* %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %71) #10, !noalias !108
...
; <label>:80:                                     ; preds = %64
  ...
  call void @_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS7_4itemENS_14default_deleteISE_EEEERyRiEEEvDpOT_(%"class.std::__1::vector.20"* nonnull %81, %"class.std::__1::unique_ptr.36"* nonnull dereferenceable(4) %7, i64* nonnull dereferenceable(8) %8, i32* nonnull dereferenceable(4) %9) #9, !noalias !108
  br label %82

; <label>:82:                                     ; preds = %80, %75
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %71) #10, !noalias !108
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %68) #10, !noalias !108
...
; <label>:85:                                     ; preds = %82
  ...
  call void @_ZdlPv(i8* %86) #11, !noalias !108
  br label %87

; <label>:87:                                     ; preds = %82, %85
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %40) #10, !noalias !108
  br label %91
...
; <label>:88:                                     ; preds = %33, %26
  ...
  call fastcc void @"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE6modifyIZNS3_11add_balanceES1_NS_5assetES1_E3$_5EEvRKS4_S1_OT_"(%"class.eosio::multi_index.19"* nonnull %10, %"struct.eosio::token::account"* nonnull dereferenceable(16) %28, %class.anon.31* nonnull dereferenceable(4) %11) #9
...
; Function Attrs: nounwind
define hidden void @_ZN5eosio5token6retireENS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE(%"class.eosio::token"* nocapture readonly, %"struct.eosio::asset"* byval align 8, %"class.std::__1::basic_string"* nocapture readnone) #0 {
  ...
  %10 = getelementptr inbounds %"class.eosio::token", %"class.eosio::token"* %0, i32 0, i32 0, i32 0, i32 0
  ...
  %19 = tail call i32 @db_find_i64(i64 %11, i64 %12, i64 -4157508551318700032, i64 %12) #9, !noalias !123
  %20 = call dereferenceable(56) %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index"* nonnull %4, i32 %19) #9, !noalias !123
  %21 = getelementptr inbounds %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item", %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* %20, i32 0, i32 0
  %22 = getelementptr inbounds %"struct.eosio::token::currency_stats", %"struct.eosio::token::currency_stats"* %21, i32 1
  %23 = bitcast %"struct.eosio::token::currency_stats"* %22 to %"class.eosio::multi_index"**
...
; <label>:26:                                     ; preds = %3
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !126
  br label %27

; <label>:27:                                     ; preds = %3, %26
  %28 = getelementptr inbounds %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item", %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* %20, i32 0, i32 0, i32 2, i32 0
  %29 = load i64, i64* %28, align 8
  call void @require_auth(i64 %29) #9
  ...
  call fastcc void @"_ZN5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE6modifyIZNS3_6retireENS_5assetENSt3__112basic_stringIcNS8_11char_traitsIcEENS8_9allocatorIcEEEEE3$_2EEvRKS4_S1_OT_"(%"class.eosio::multi_index"* nonnull %4, %"struct.eosio::token::currency_stats"* nonnull dereferenceable(40) %21, %class.anon.18* nonnull dereferenceable(4) %5) #12
  ...
  call void @_ZN5eosio5token11sub_balanceENS_4nameENS_5assetE(%"class.eosio::token"* nonnull %0, i64 %32, %"struct.eosio::asset"* byval nonnull align 8 %6) #12
  ...
  %37 = load %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"*, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"** %36, align 8, !tbaa !12
  %38 = icmp eq %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* %37, null
  br i1 %38, label %58, label %39

; <label>:39:                                     ; preds = %27
  %40 = bitcast %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* %37 to i8*
  %41 = load %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"*, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"** %17, align 4, !tbaa !16
  %42 = icmp eq %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* %41, %37
  br i1 %42, label %56, label %43

; <label>:43:                                     ; preds = %39, %51
  %44 = phi %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* [ %45, %51 ], [ %41, %39 ]
  %45 = getelementptr inbounds %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr", %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* %44, i32 -1
  %46 = getelementptr inbounds %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr", %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* %45, i32 0, i32 0, i32 0, i32 0, i32 0
  %47 = load %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"*, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"** %46, align 4, !tbaa !43
  store %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* null, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"** %46, align 4, !tbaa !43
  %48 = icmp eq %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* %47, null
  br i1 %48, label %51, label %49

; <label>:49:                                     ; preds = %43
  %50 = bitcast %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* %47 to i8*
  call void @_ZdlPv(i8* %50) #11
  br label %51

; <label>:51:                                     ; preds = %49, %43
  %52 = icmp eq %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* %45, %37
...
; <label>:56:                                     ; preds = %53, %39
  ...
  store %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* %37, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"** %17, align 4, !tbaa !16
...
; Function Attrs: nounwind
define internal fastcc void @"_ZN5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE6modifyIZNS3_6retireENS_5assetENSt3__112basic_stringIcNS8_11char_traitsIcEENS8_9allocatorIcEEEEE3$_2EEvRKS4_S1_OT_"(%"class.eosio::multi_index"*, %"struct.eosio::token::currency_stats"* dereferenceable(40), %class.anon.18* nocapture readonly dereferenceable(4)) unnamed_addr #0 {
  %4 = alloca %"struct.boost::pfr::detail::sequence_tuple::tuple.84", align 4
  %5 = alloca %class.anon.99, align 4
  %6 = alloca %"class.eosio::datastream.79", align 4
  %7 = bitcast %"struct.eosio::token::currency_stats"* %1 to %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"*
...
; <label>:28:                                     ; preds = %19
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.15, i32 0, i32 0)) #9
  br label %29
...
; <label>:36:                                     ; preds = %29
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.16, i32 0, i32 0)) #9
  %37 = load i64, i64* %32, align 8, !tbaa !35
  br label %38
...
; <label>:41:                                     ; preds = %38
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.17, i32 0, i32 0)) #9
  br label %42
...
define hidden void @_ZN5eosio5token11sub_balanceENS_4nameENS_5assetE(%"class.eosio::token"* nocapture readonly, i64, %"struct.eosio::asset"* byval align 8) local_unnamed_addr #0 {
  ...
  %17 = lshr i64 %16, 8
  %18 = tail call i32 @db_find_i64(i64 %8, i64 %1, i64 3607749779137757184, i64 %17) #9, !noalias !142
  %19 = icmp slt i32 %18, 0
  br i1 %19, label %28, label %20

; <label>:20:                                     ; preds = %3
  %21 = call dereferenceable(32) %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index.19"* nonnull %4, i32 %18) #9, !noalias !142
  ...
  %24 = bitcast %"struct.eosio::token::account"* %23 to %"class.eosio::multi_index.19"**
...
; <label>:27:                                     ; preds = %20
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !145
  br label %29

; <label>:28:                                     ; preds = %3
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0)) #9
  br label %29
...
; <label>:29:                                     ; preds = %20, %27, %28
  ...
  call fastcc void @"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE6modifyIZNS3_11sub_balanceES1_NS_5assetEE3$_3EEvRKS4_S1_OT_"(%"class.eosio::multi_index.19"* nonnull %4, %"struct.eosio::token::account"* nonnull dereferenceable(16) %30, i64 %1, %class.anon.28* nonnull dereferenceable(4) %5) #12
  ...
  %35 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %34, align 8, !tbaa !94
  %36 = icmp eq %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %35, null
  br i1 %36, label %56, label %37

; <label>:37:                                     ; preds = %29
  %38 = bitcast %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %35 to i8*
  %39 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %13, align 4, !tbaa !97
  %40 = icmp eq %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %39, %35
  br i1 %40, label %54, label %41

; <label>:41:                                     ; preds = %37, %49
  %42 = phi %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* [ %43, %49 ], [ %39, %37 ]
  %43 = getelementptr inbounds %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr", %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %42, i32 -1
  %44 = getelementptr inbounds %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr", %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %43, i32 0, i32 0, i32 0, i32 0, i32 0
  %45 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %44, align 4, !tbaa !43
  store %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* null, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %44, align 4, !tbaa !43
  %46 = icmp eq %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* %45, null
  br i1 %46, label %49, label %47

; <label>:47:                                     ; preds = %41
  %48 = bitcast %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* %45 to i8*
  call void @_ZdlPv(i8* %48) #11
  br label %49

; <label>:49:                                     ; preds = %47, %41
  %50 = icmp eq %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %43, %35
...
; <label>:54:                                     ; preds = %51, %37
  ...
  store %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %35, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %13, align 4, !tbaa !97
...
define hidden void @_ZN5eosio5token8transferENS_4nameES1_NS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEE(%"class.eosio::token"* nocapture readonly, i64, i64, %"struct.eosio::asset"* byval nocapture readonly align 8, %"class.std::__1::basic_string"* nocapture readnone) #0 {
  ...
  %21 = call dereferenceable(40) %"struct.eosio::token::currency_stats"* @_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE3getEyPKc(%"class.eosio::multi_index"* nonnull %6, i64 %11, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0)) #12
  call void @require_recipient(i64 %1) #9
  call void @require_recipient(i64 %2) #9
  %22 = call zeroext i1 @has_auth(i64 %2) #9
  ...
  call void @_ZN5eosio5token11sub_balanceENS_4nameENS_5assetE(%"class.eosio::token"* %0, i64 %1, %"struct.eosio::asset"* byval nonnull align 8 %7) #12
  ...
  call void @_ZN5eosio5token11add_balanceENS_4nameENS_5assetES1_(%"class.eosio::token"* %0, i64 %2, %"struct.eosio::asset"* byval nonnull align 8 %8, i64 %23) #12
...
define linkonce_odr hidden dereferenceable(40) %"struct.eosio::token::currency_stats"* @_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE3getEyPKc(%"class.eosio::multi_index"*, i64, i8*) local_unnamed_addr #0 comdat {
  ...
  %5 = load %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"*, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"** %4, align 4, !tbaa !16, !noalias !148
  %6 = getelementptr inbounds %"class.eosio::multi_index", %"class.eosio::multi_index"* %0, i32 0, i32 3, i32 0, i32 0
  %7 = load %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"*, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"** %6, align 4, !tbaa !12, !noalias !153
...
; <label>:9:                                      ; preds = %3, %18
  ...
  %13 = load %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"*, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"** %12, align 4, !tbaa !43, !noalias !156
...
; <label>:28:                                     ; preds = %22
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !159
  br label %45
...
; <label>:29:                                     ; preds = %18, %20, %3
  ...
  %34 = tail call i32 @db_find_i64(i64 %31, i64 %33, i64 -4157508551318700032, i64 %1) #9, !noalias !163
  %35 = icmp slt i32 %34, 0
  br i1 %35, label %44, label %36

; <label>:36:                                     ; preds = %29
  %37 = tail call dereferenceable(56) %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index"* nonnull %0, i32 %34) #9, !noalias !163
...
; <label>:43:                                     ; preds = %36
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !164
  br label %45

; <label>:44:                                     ; preds = %29
  tail call void @eosio_assert(i32 0, i8* %2) #9
  br label %45
...
; Function Attrs: nounwind
define internal fastcc void @"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE6modifyIZNS3_11sub_balanceES1_NS_5assetEE3$_3EEvRKS4_S1_OT_"(%"class.eosio::multi_index.19"*, %"struct.eosio::token::account"* dereferenceable(16), i64, %class.anon.28* nocapture readonly dereferenceable(4)) unnamed_addr #0 {
  %5 = alloca i64, align 8
...
; <label>:46:                                     ; preds = %45, %41
  ...
  %50 = call i8* @memcpy(i8* nonnull %48, i8* nonnull %49, i32 8) #9
  ...
  %54 = call i8* @memcpy(i8* nonnull %51, i8* nonnull %53, i32 8) #9
  ...
  call void @db_update_i64(i32 %56, i64 %2, i8* nonnull %48, i32 16) #9
...
define hidden void @_ZN5eosio5token4openENS_4nameERKNS_6symbolES1_(%"class.eosio::token"* nocapture readonly, i64, %"class.eosio::symbol"* dereferenceable(8), i64) #0 {
  ...
  tail call void @require_auth(i64 %3) #9
  ...
  store %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"* null, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"** %24, align 8, !tbaa !17
  %25 = call dereferenceable(40) %"struct.eosio::token::currency_stats"* @_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE3getEyPKc(%"class.eosio::multi_index"* nonnull %10, i64 %15, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i32 0, i32 0)) #12
  ...
  %34 = call i32 @db_find_i64(i64 %27, i64 %1, i64 3607749779137757184, i64 %15) #9, !noalias !169
  %35 = icmp slt i32 %34, 0
  br i1 %35, label %44, label %36

; <label>:36:                                     ; preds = %4
  %37 = call dereferenceable(32) %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index.19"* nonnull %11, i32 %34) #9, !noalias !169
...
; <label>:43:                                     ; preds = %36
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !172
  br label %93
...
; <label>:44:                                     ; preds = %4
  ...
  %49 = call i64 @current_receiver() #9, !noalias !175
  %50 = load i64, i64* %28, align 8, !tbaa !31, !noalias !175
  %51 = icmp eq i64 %50, %49
  br i1 %51, label %53, label %52

; <label>:52:                                     ; preds = %44
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.7, i32 0, i32 0)) #9, !noalias !175
  br label %53

; <label>:53:                                     ; preds = %52, %44
  %54 = bitcast %"class.std::__1::unique_ptr.36"* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %54) #10, !noalias !175
  %55 = ptrtoint %"class.eosio::multi_index.19"* %11 to i32
  %56 = bitcast %class.anon.171* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %56) #10, !noalias !175
  ...
  %60 = call i8* @_Znwj(i32 32) #11, !noalias !180
  ...
  call fastcc void @"_ZZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE7emplaceIZNS3_4openES1_RKNS_6symbolES1_E3$_6EENS5_14const_iteratorES1_OT_ENKUlRSC_E_clINS5_4itemEEEDaSE_"(%class.anon.171* nonnull %7, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* dereferenceable(32) %61) #9, !noalias !180
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %56) #10, !noalias !175
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %70) #10, !noalias !175
  %71 = load i64, i64* %64, align 8, !tbaa !55, !noalias !175
  %72 = lshr i64 %71, 8
  store i64 %72, i64* %8, align 8, !tbaa !2, !noalias !175
  %73 = bitcast i32* %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %73) #10, !noalias !175
  ...
  %77 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %32, align 4, !tbaa !97, !noalias !175
  %78 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %33, align 8, !tbaa !43, !noalias !175
  %79 = icmp ult %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %77, %78
  br i1 %79, label %80, label %85

; <label>:80:                                     ; preds = %53
  store %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* null, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %69, align 4, !tbaa !43, !noalias !175
  ...
  store %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %84, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %32, align 4, !tbaa !97, !noalias !175
  br label %87

; <label>:85:                                     ; preds = %53
  %86 = getelementptr inbounds %"class.eosio::multi_index.19", %"class.eosio::multi_index.19"* %11, i32 0, i32 3
  call void @_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS7_4itemENS_14default_deleteISE_EEEERyRiEEEvDpOT_(%"class.std::__1::vector.20"* nonnull %86, %"class.std::__1::unique_ptr.36"* nonnull dereferenceable(4) %6, i64* nonnull dereferenceable(8) %8, i32* nonnull dereferenceable(4) %9) #9, !noalias !175
  br label %87

; <label>:87:                                     ; preds = %85, %80
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %73) #10, !noalias !175
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %70) #10, !noalias !175
  %88 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %69, align 4, !tbaa !43, !noalias !175
  store %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* null, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %69, align 4, !tbaa !43, !noalias !175
...
; <label>:90:                                     ; preds = %87
  ...
  call void @_ZdlPv(i8* %91) #11, !noalias !175
  br label %92

; <label>:92:                                     ; preds = %87, %90
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %54) #10, !noalias !175
...
; Function Attrs: nounwind
define hidden void @_ZN5eosio5token5closeENS_4nameERKNS_6symbolE(%"class.eosio::token"* nocapture readonly, i64, %"class.eosio::symbol"* nocapture readonly dereferenceable(8)) #0 {
  ...
  %16 = load i64, i64* %15, align 8, !tbaa !55
  %17 = lshr i64 %16, 8
  %18 = tail call i32 @db_find_i64(i64 %8, i64 %1, i64 3607749779137757184, i64 %17) #9, !noalias !184
  %19 = icmp slt i32 %18, 0
  br i1 %19, label %30, label %20

; <label>:20:                                     ; preds = %3
  %21 = call dereferenceable(32) %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index.19"* nonnull %5, i32 %18) #9, !noalias !184
  %22 = getelementptr inbounds %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item", %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* %21, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.eosio::token::account", %"struct.eosio::token::account"* %22, i32 1
  %24 = bitcast %"struct.eosio::token::account"* %23 to %"class.eosio::multi_index.19"**
...
; <label>:27:                                     ; preds = %20
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i32 0, i32 0)) #9, !noalias !187
  br label %28

; <label>:28:                                     ; preds = %20, %27
  %29 = getelementptr inbounds %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item", %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* %21, i32 0, i32 0
  br label %31

; <label>:30:                                     ; preds = %3
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.21, i32 0, i32 0)) #9, !noalias !190
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.22, i32 0, i32 0)) #9, !noalias !190
  br label %31

; <label>:31:                                     ; preds = %28, %30
  %32 = phi %"struct.eosio::token::account"* [ null, %30 ], [ %29, %28 ]
  %33 = phi %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* [ null, %30 ], [ %21, %28 ]
  %34 = bitcast i64* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %34) #10, !noalias !190
  %35 = getelementptr inbounds %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item", %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* %33, i32 0, i32 2
  %36 = load i32, i32* %35, align 4, !tbaa !114, !noalias !190
  %37 = call i32 @db_next_i64(i32 %36, i64* nonnull %4) #9, !noalias !190
  %38 = icmp slt i32 %37, 0
  br i1 %38, label %41, label %39

; <label>:39:                                     ; preds = %31
  %40 = call dereferenceable(32) %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index.19"* nonnull %5, i32 %37) #9, !noalias !190
  br label %41

; <label>:41:                                     ; preds = %31, %39
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %34) #10, !noalias !190
  call void @_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE5eraseERKS4_(%"class.eosio::multi_index.19"* nonnull %5, %"struct.eosio::token::account"* nonnull dereferenceable(16) %32) #9, !noalias !190
  ...
  %44 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %43, align 8, !tbaa !94
  %45 = icmp eq %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %44, null
  br i1 %45, label %65, label %46

; <label>:46:                                     ; preds = %41
  %47 = bitcast %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %44 to i8*
  %48 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %13, align 4, !tbaa !97
  %49 = icmp eq %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %48, %44
  br i1 %49, label %63, label %50

; <label>:50:                                     ; preds = %46, %58
  %51 = phi %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* [ %52, %58 ], [ %48, %46 ]
  %52 = getelementptr inbounds %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr", %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %51, i32 -1
  %53 = getelementptr inbounds %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr", %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %52, i32 0, i32 0, i32 0, i32 0, i32 0
  %54 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %53, align 4, !tbaa !43
  store %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* null, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %53, align 4, !tbaa !43
  %55 = icmp eq %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* %54, null
  br i1 %55, label %58, label %56

; <label>:56:                                     ; preds = %50
  %57 = bitcast %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* %54 to i8*
  call void @_ZdlPv(i8* %57) #11
  br label %58

; <label>:58:                                     ; preds = %56, %50
  %59 = icmp eq %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %52, %44
...
; <label>:63:                                     ; preds = %60, %46
  ...
  store %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"* %44, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %13, align 4, !tbaa !97
...
define hidden void @apply(i64, i64, i64) local_unnamed_addr #2 {
  tail call void @__wasm_call_ctors() #10
...
; <label>:12:                                     ; preds = %11
  ...
  store i32 ptrtoint (void (%"class.eosio::token"*, i64, %"struct.eosio::asset"*)* @_ZN5eosio5token6createENS_4nameENS_5assetE to i32), i32* %13, align 4, !tbaa !76
  %14 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %4, i32 0, i32 1
  store i32 0, i32* %14, align 4, !tbaa !76
  %15 = call zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameENS_5assetEEEEbS2_S2_MT_FvDpT0_E(i64 %1, i64 %1, { i32, i32 }* byval nonnull align 4 %4) #12
  br label %36

; <label>:16:                                     ; preds = %11
  %17 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %5, i32 0, i32 0
  store i32 ptrtoint (void (%"class.eosio::token"*, i64, %"struct.eosio::asset"*, %"class.std::__1::basic_string"*)* @_ZN5eosio5token5issueENS_4nameENS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEE to i32), i32* %17, align 4, !tbaa !76
  %18 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %5, i32 0, i32 1
  store i32 0, i32* %18, align 4, !tbaa !76
  %19 = call zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameENS_5assetENSt3__112basic_stringIcNS4_11char_traitsIcEENS4_9allocatorIcEEEEEEEbS2_S2_MT_FvDpT0_E(i64 %1, i64 %1, { i32, i32 }* byval nonnull align 4 %5) #12
  br label %36

; <label>:20:                                     ; preds = %11
  %21 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %6, i32 0, i32 0
  store i32 ptrtoint (void (%"class.eosio::token"*, i64, i64, %"struct.eosio::asset"*, %"class.std::__1::basic_string"*)* @_ZN5eosio5token8transferENS_4nameES1_NS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEE to i32), i32* %21, align 4, !tbaa !76
  %22 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %6, i32 0, i32 1
  store i32 0, i32* %22, align 4, !tbaa !76
  %23 = call zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameES2_NS_5assetENSt3__112basic_stringIcNS4_11char_traitsIcEENS4_9allocatorIcEEEEEEEbS2_S2_MT_FvDpT0_E(i64 %1, i64 %1, { i32, i32 }* byval nonnull align 4 %6) #12
  br label %36

; <label>:24:                                     ; preds = %11
  %25 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %7, i32 0, i32 0
  store i32 ptrtoint (void (%"class.eosio::token"*, i64, %"class.eosio::symbol"*, i64)* @_ZN5eosio5token4openENS_4nameERKNS_6symbolES1_ to i32), i32* %25, align 4, !tbaa !76
  %26 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %7, i32 0, i32 1
  store i32 0, i32* %26, align 4, !tbaa !76
  %27 = call zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameERKNS_6symbolES2_EEEbS2_S2_MT_FvDpT0_E(i64 %1, i64 %1, { i32, i32 }* byval nonnull align 4 %7) #12
  br label %36

; <label>:28:                                     ; preds = %11
  %29 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %8, i32 0, i32 0
  store i32 ptrtoint (void (%"class.eosio::token"*, i64, %"class.eosio::symbol"*)* @_ZN5eosio5token5closeENS_4nameERKNS_6symbolE to i32), i32* %29, align 4, !tbaa !76
  %30 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %8, i32 0, i32 1
  store i32 0, i32* %30, align 4, !tbaa !76
  %31 = call zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameERKNS_6symbolEEEEbS2_S2_MT_FvDpT0_E(i64 %1, i64 %1, { i32, i32 }* byval nonnull align 4 %8) #12
  br label %36

; <label>:32:                                     ; preds = %11
  %33 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %9, i32 0, i32 0
  store i32 ptrtoint (void (%"class.eosio::token"*, %"struct.eosio::asset"*, %"class.std::__1::basic_string"*)* @_ZN5eosio5token6retireENS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE to i32), i32* %33, align 4, !tbaa !76
  %34 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %9, i32 0, i32 1
  store i32 0, i32* %34, align 4, !tbaa !76
  %35 = call zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEEEEbNS_4nameESA_MT_FvDpT0_E(i64 %1, i64 %1, { i32, i32 }* byval nonnull align 4 %9) #12
  br label %36

; <label>:36:                                     ; preds = %12, %16, %20, %24, %28, %32, %11, %3
  call void @__cxa_finalize(i32 0) #10
  ret void
}
...
define linkonce_odr hidden zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameENS_5assetEEEEbS2_S2_MT_FvDpT0_E(i64, i64, { i32, i32 }* byval align 4) local_unnamed_addr #0 comdat {
  ...
  %19 = tail call i32 @action_data_size() #9
  %20 = icmp eq i32 %19, 0
...
; <label>:23:                                     ; preds = %21
  %24 = tail call i8* @malloc(i32 %19) #9
  br label %27
...
; <label>:27:                                     ; preds = %25, %23
  ...
  %29 = call i32 @read_action_data(i8* %28, i32 %19) #9
  br label %30
...
; <label>:30:                                     ; preds = %3, %27
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %36) #10
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %47, i8* nonnull align 4 %46, i64 12, i1 false) #10
  %48 = bitcast %"class.eosio::datastream"* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %48)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %48, i8* nonnull align 8 %47, i64 12, i1 false) #10
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %52, i8* nonnull align 8 %48, i32 12, i1 false) #10, !tbaa.struct !197
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %53, i8* nonnull align 8 %56, i32 16, i1 false) #10, !tbaa.struct !38
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %57, i8* nonnull align 8 %53, i64 16, i1 false) #10
  %59 = ashr i32 %18, 1
...
; <label>:72:                                     ; preds = %64, %70
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %58, i8* nonnull align 8 %57, i32 16, i1 false) #10, !tbaa.struct !38
  call void %73(%"class.eosio::token"* %61, i64 %54, %"struct.eosio::asset"* byval nonnull align 8 %8) #9
...
; <label>:76:                                     ; preds = %75, %72
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %36) #10
...
; <label>:30:                                     ; preds = %3, %27
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %40) #10
...
; <label>:48:                                     ; preds = %30
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0)) #9
...
; <label>:51:                                     ; preds = %30, %48
  ...
  %54 = call i8* @memcpy(i8* nonnull %32, i8* %53, i32 8) #9
...
; <label>:64:                                     ; preds = %61, %51
  ...
  %67 = call i8* @memcpy(i8* nonnull %57, i8* %66, i32 8) #9
...
; <label>:75:                                     ; preds = %64, %73
  ...
  %77 = call i8* @memcpy(i8* nonnull %69, i8* %76, i32 8) #9
  ...
  %81 = call dereferenceable(12) %"class.eosio::datastream"* @_ZN5eosiorsINS_10datastreamIPKcEEEERT_S6_RNSt3__112basic_stringIcNS7_11char_traitsIcEENS7_9allocatorIcEEEE(%"class.eosio::datastream"* nonnull dereferenceable(12) %9, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %80) #9
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %84, i8* nonnull align 4 %83, i64 12, i1 false) #10
  %85 = bitcast %"class.eosio::datastream"* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %85)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %85, i8* nonnull align 8 %84, i64 12, i1 false) #10
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %89, i8* nonnull align 8 %85, i32 12, i1 false) #10, !tbaa.struct !197
...
; <label>:95:                                     ; preds = %94, %75
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %40) #10
...
define linkonce_odr hidden zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameES2_NS_5assetENSt3__112basic_stringIcNS4_11char_traitsIcEENS4_9allocatorIcEEEEEEEbS2_S2_MT_FvDpT0_E(i64, i64, { i32, i32 }* byval align 4) local_unnamed_addr #0 comdat {
  ...
  %20 = tail call i32 @action_data_size() #9
  %21 = icmp eq i32 %20, 0
...
; <label>:24:                                     ; preds = %22
  %25 = tail call i8* @malloc(i32 %20) #9
  br label %28
...
; <label>:28:                                     ; preds = %26, %24
  ...
  %30 = call i32 @read_action_data(i8* %29, i32 %20) #9
  br label %31
...
; <label>:31:                                     ; preds = %3, %28
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %42) #10
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %53, i8* nonnull align 4 %52, i64 12, i1 false) #10
  %54 = bitcast %"class.eosio::datastream"* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %54)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %54, i8* nonnull align 8 %53, i64 12, i1 false) #10
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %58, i8* nonnull align 8 %54, i32 12, i1 false) #10, !tbaa.struct !197
...
; <label>:64:                                     ; preds = %63, %31
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %42) #10
...
define linkonce_odr hidden zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameERKNS_6symbolES2_EEEbS2_S2_MT_FvDpT0_E(i64, i64, { i32, i32 }* byval align 4) local_unnamed_addr #0 comdat {
  ...
  %15 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %2, i32 0, i32 1
  %16 = load i32, i32* %15, align 4, !tbaa !76
  %17 = tail call i32 @action_data_size() #9
  %18 = icmp eq i32 %17, 0
...
; <label>:21:                                     ; preds = %19
  %22 = tail call i8* @malloc(i32 %17) #9
  br label %25
...
; <label>:25:                                     ; preds = %23, %21
  ...
  %27 = call i32 @read_action_data(i8* %26, i32 %17) #9
  br label %28
...
; <label>:28:                                     ; preds = %3, %25
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %34) #10
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %45, i8* nonnull align 4 %44, i64 12, i1 false) #10
  %46 = bitcast %"class.eosio::datastream"* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %46)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %46, i8* nonnull align 8 %45, i64 12, i1 false) #10
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %50, i8* nonnull align 8 %46, i32 12, i1 false) #10, !tbaa.struct !197
...
; <label>:69:                                     ; preds = %61, %67
  ...
  call void %70(%"class.eosio::token"* %58, i64 %51, %"class.eosio::symbol"* nonnull dereferenceable(8) %8, i64 %53) #9
...
; <label>:73:                                     ; preds = %72, %69
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %34) #10
...
define linkonce_odr hidden zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_4nameERKNS_6symbolEEEEbS2_S2_MT_FvDpT0_E(i64, i64, { i32, i32 }* byval align 4) local_unnamed_addr #0 comdat {
  ...
  %12 = tail call i32 @action_data_size() #9
  %13 = icmp eq i32 %12, 0
...
; <label>:16:                                     ; preds = %14
  %17 = tail call i8* @malloc(i32 %12) #9
  br label %20
...
; <label>:20:                                     ; preds = %18, %16
  ...
  %22 = call i32 @read_action_data(i8* %21, i32 %12) #9
  br label %23
...
; <label>:32:                                     ; preds = %31, %23
  %33 = call i8* @memcpy(i8* nonnull %25, i8* %24, i32 8) #9
...
; <label>:39:                                     ; preds = %32, %38
  %40 = call i8* @memcpy(i8* nonnull %35, i8* nonnull %34, i32 8) #9
...
; <label>:68:                                     ; preds = %60, %66
  ...
  call void %69(%"class.eosio::token"* %57, i64 %52, %"class.eosio::symbol"* nonnull dereferenceable(8) %5) #9
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %53) #10
...
; Function Attrs: nounwind
define linkonce_odr hidden zeroext i1 @_ZN5eosio14execute_actionINS_5tokenEJNS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEEEEbNS_4nameESA_MT_FvDpT0_E(i64, i64, { i32, i32 }* byval align 4) local_unnamed_addr #0 comdat {
  %4 = alloca %"class.eosio::datastream", align 8
  %5 = alloca %"class.eosio::datastream", align 8
...
; <label>:31:                                     ; preds = %3, %28
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %51, i8* nonnull align 4 %50, i64 12, i1 false) #10
  %52 = bitcast %"class.eosio::datastream"* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %52)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %52, i8* nonnull align 8 %51, i64 12, i1 false) #10
  %53 = getelementptr inbounds %"class.eosio::token", %"class.eosio::token"* %11, i32 0, i32 0, i32 0, i32 0
  store i64 %0, i64* %53, align 8
  %54 = getelementptr inbounds %"class.eosio::token", %"class.eosio::token"* %11, i32 0, i32 0, i32 1, i32 0
  store i64 %1, i64* %54, align 8
  %55 = getelementptr inbounds %"class.eosio::token", %"class.eosio::token"* %11, i32 0, i32 0, i32 2
  %56 = bitcast %"class.eosio::datastream"* %55 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %56, i8* nonnull align 8 %52, i32 12, i1 false) #10, !tbaa.struct !197
  ...
  store %"class.eosio::token"* %11, %"class.eosio::token"** %58, align 4, !tbaa !43
  %59 = getelementptr inbounds %class.anon.253, %class.anon.253* %13, i32 0, i32 1
  store { i32, i32 }* %8, { i32, i32 }** %59, align 4, !tbaa !43
  call void @_ZN5boost4mp116detail16tuple_apply_implIRZN5eosio14execute_actionINS3_5tokenEJNS3_5assetENSt3__112basic_stringIcNS7_11char_traitsIcEENS7_9allocatorIcEEEEEEEbNS3_4nameESE_MT_FvDpT0_EEUlDpT_E_RNS7_5tupleIJS6_SD_EEEJLj0ELj1EEEEDTclclsr3stdE7forwardISF_Efp_Espclsr3stdE3getIXT1_EEclsr3stdE7forwardIT0_Efp0_EEEEOSF_OSR_NS0_16integer_sequenceIjJXspT1_EEEE(%class.anon.253* nonnull dereferenceable(8) %13, %"class.std::__1::tuple.248"* nonnull dereferenceable(32) %9) #9
...
define linkonce_odr hidden dereferenceable(56) %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index"*, i32) local_unnamed_addr #0 comdat {
  ...
  %11 = load %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"*, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"** %10, align 4, !tbaa !16, !noalias !200
  %12 = getelementptr inbounds %"class.std::__1::vector", %"class.std::__1::vector"* %9, i32 0, i32 0, i32 0
  %13 = load %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"*, %"struct.eosio::multi_index<14289235522390851584, eosio::token::currency_stats>::item_ptr"** %12, align 4, !tbaa !12, !noalias !203
...
; <label>:15:                                     ; preds = %2, %20
  ...
  %18 = load i32, i32* %17, align 8, !tbaa !65, !noalias !206
  %19 = icmp eq i32 %18, %1
...
; <label>:31:                                     ; preds = %28
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.4, i32 0, i32 0)) #9
  br label %34
...
; <label>:34:                                     ; preds = %31, %32
  %35 = tail call i8* @malloc(i32 %29) #9
  br label %38
...
; <label>:38:                                     ; preds = %36, %34
  ...
  %41 = call i32 @db_get_i64(i32 %1, i8* %40, i32 %29) #9
  ...
  %50 = call i8* @_Znwj(i32 56) #11, !noalias !209
  %51 = bitcast i8* %50 to i64*
  store i64 0, i64* %51, align 8, !tbaa !35, !noalias !209
  %52 = getelementptr inbounds i8, i8* %50, i32 8
  %53 = bitcast i8* %52 to i64*
  store i64 0, i64* %53, align 8, !tbaa !55, !noalias !209
  %54 = getelementptr inbounds i8, i8* %50, i32 16
  %55 = bitcast i8* %54 to i64*
  store i64 0, i64* %55, align 8, !tbaa !35, !noalias !209
  %56 = getelementptr inbounds i8, i8* %50, i32 24
  %57 = bitcast i8* %56 to i64*
  store i64 0, i64* %57, align 8, !tbaa !55, !noalias !209
  %58 = getelementptr inbounds i8, i8* %50, i32 32
  %59 = bitcast i8* %58 to i64*
  store i64 0, i64* %59, align 8, !tbaa !31, !noalias !209
  %60 = getelementptr inbounds i8, i8* %50, i32 40
  %61 = bitcast i8* %60 to i32*
  store i32 %48, i32* %61, align 8, !tbaa !22, !noalias !209
  %62 = bitcast %class.anon.51* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %62) #10, !noalias !209
  %63 = bitcast %class.anon.51* %4 to i32*
  store i32 %49, i32* %63, align 4, !tbaa !43, !noalias !209
  %64 = bitcast %"struct.boost::pfr::detail::sequence_tuple::tuple"* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %64) #10, !noalias !209
  ...
  store i32 %65, i32* %68, align 4, !tbaa !43, !alias.scope !212, !noalias !209
  ...
  store i32 %66, i32* %70, align 4, !tbaa !43, !alias.scope !212, !noalias !209
...
; <label>:92:                                     ; preds = %38
  call void @_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS7_4itemENS_14default_deleteISE_EEEERyRiEEEvDpOT_(%"class.std::__1::vector"* nonnull %9, %"class.std::__1::unique_ptr"* nonnull dereferenceable(4) %6, i64* nonnull dereferenceable(8) %7, i32* nonnull dereferenceable(4) %8) #9
  br label %93
...
define linkonce_odr hidden void @_ZN5boost3pfr6detail19for_each_field_implINS1_14sequence_tuple5tupleIJRN5eosio5assetES7_RNS5_4nameEEEEZNS5_rsINS5_10datastreamIPKcEENS5_5token14currency_statsELPv0EEERT_SK_RT0_EUlSK_E_JLj0ELj1ELj2EEEEvSK_OSL_NSt3__116integer_sequenceIjJXspT1_EEEENSP_17integral_constantIbLb0EEE(%"struct.boost::pfr::detail::sequence_tuple::tuple"* dereferenceable(12), %class.anon.50* dereferenceable(4)) local_unnamed_addr #0 comdat {
  ...
  %6 = load %"struct.eosio::asset"*, %"struct.eosio::asset"** %5, align 4, !tbaa !223
  %7 = getelementptr inbounds %class.anon.50, %class.anon.50* %1, i32 0, i32 0
  %8 = load %"class.eosio::datastream"*, %"class.eosio::datastream"** %7, align 4, !tbaa !225
...
; <label>:19:                                     ; preds = %2
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0)) #9
  %20 = load i8*, i8** %13, align 4, !tbaa !195
  br label %21

; <label>:21:                                     ; preds = %19, %2
  %22 = phi i8* [ %18, %2 ], [ %20, %19 ]
  %23 = tail call i8* @memcpy(i8* nonnull %9, i8* %22, i32 8) #9
...
; <label>:33:                                     ; preds = %21, %31
  ...
  %35 = call i8* @memcpy(i8* nonnull %26, i8* %34, i32 8) #9
  ...
  %41 = load %"struct.eosio::asset"*, %"struct.eosio::asset"** %40, align 4, !tbaa !227
  %42 = load %"class.eosio::datastream"*, %"class.eosio::datastream"** %7, align 4, !tbaa !225
...
; <label>:55:                                     ; preds = %53, %33
  ...
  %57 = call i8* @memcpy(i8* nonnull %43, i8* %56, i32 8) #9
...
; <label>:67:                                     ; preds = %55, %65
  ...
  %69 = call i8* @memcpy(i8* nonnull %60, i8* %68, i32 8) #9
  ...
  %76 = load i8*, i8** %75, align 4, !tbaa !229
  %77 = load %"class.eosio::datastream"*, %"class.eosio::datastream"** %7, align 4, !tbaa !225
...
; <label>:89:                                     ; preds = %67, %87
  ...
  %91 = call i8* @memcpy(i8* nonnull %76, i8* %90, i32 8) #9
...
; <label>:55:                                     ; preds = %33, %55
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %66, i8* nonnull align 8 %67, i64 12, i1 false) #10
...
define linkonce_odr hidden void @_ZN5boost3pfr6detail19for_each_field_implINS1_14sequence_tuple5tupleIJRKN5eosio5assetES8_RKNS5_4nameEEEEZNS5_lsINS5_10datastreamIPcEENS5_5token14currency_statsELPv0EEERT_SL_RKT0_EUlRKSK_E_JLj0ELj1ELj2EEEEvSL_OSM_NSt3__116integer_sequenceIjJXspT1_EEEENST_17integral_constantIbLb0EEE(%"struct.boost::pfr::detail::sequence_tuple::tuple.84"* dereferenceable(12), %class.anon.98* dereferenceable(4)) local_unnamed_addr #0 comdat {
  ...
  %6 = load %"struct.eosio::asset"*, %"struct.eosio::asset"** %5, align 4, !tbaa !231
  %7 = getelementptr inbounds %class.anon.98, %class.anon.98* %1, i32 0, i32 0
  %8 = load %"class.eosio::datastream.79"*, %"class.eosio::datastream.79"** %7, align 4, !tbaa !233
  %9 = bitcast %"struct.eosio::asset"* %6 to i8*
...
; <label>:19:                                     ; preds = %2
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8, i32 0, i32 0)) #9
  %20 = load i8*, i8** %13, align 4, !tbaa !41
  br label %21

; <label>:21:                                     ; preds = %19, %2
  %22 = phi i8* [ %18, %2 ], [ %20, %19 ]
  %23 = tail call i8* @memcpy(i8* %22, i8* nonnull %9, i32 8) #9
...
; <label>:35:                                     ; preds = %21, %33
  ...
  %37 = call i8* @memcpy(i8* %36, i8* nonnull %28, i32 8) #9
  ...
  %41 = load %"struct.eosio::asset"*, %"struct.eosio::asset"** %40, align 4, !tbaa !235
  %42 = load %"class.eosio::datastream.79"*, %"class.eosio::datastream.79"** %7, align 4, !tbaa !233
  %43 = bitcast %"struct.eosio::asset"* %41 to i8*
...
; <label>:53:                                     ; preds = %35
  call void @eosio_assert(i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8, i32 0, i32 0)) #9
  %54 = load i8*, i8** %47, align 4, !tbaa !41
  br label %55

; <label>:55:                                     ; preds = %53, %35
  %56 = phi i8* [ %52, %35 ], [ %54, %53 ]
  %57 = call i8* @memcpy(i8* %56, i8* nonnull %43, i32 8) #9
...
; <label>:69:                                     ; preds = %55, %67
  ...
  %71 = call i8* @memcpy(i8* %70, i8* nonnull %62, i32 8) #9
  ...
  %75 = bitcast %"struct.eosio::name"** %74 to i8**
  %76 = load i8*, i8** %75, align 4, !tbaa !237
  %77 = load %"class.eosio::datastream.79"*, %"class.eosio::datastream.79"** %7, align 4, !tbaa !233
...
; <label>:89:                                     ; preds = %69, %87
  ...
  %91 = call i8* @memcpy(i8* %90, i8* nonnull %76, i32 8) #9
...
define linkonce_odr hidden void @_ZN5eosio15dispatch_inlineIJNS_4nameES1_NS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEEEEvS1_S1_NS3_6vectorINS_16permission_levelENS7_ISB_EEEENS3_5tupleIJDpT_EEE(i64, i64, %"class.std::__1::vector.8"*, %"class.std::__1::tuple"*) local_unnamed_addr #0 comdat {
  ...
  store %"struct.eosio::permission_level"* null, %"struct.eosio::permission_level"** %15, align 4, !tbaa !239
...
; <label>:28:                                     ; preds = %24
  %29 = tail call i8* @_Znwj(i32 %21) #11
...
; <label>:42:                                     ; preds = %28
  ...
  %45 = tail call i8* @memcpy(i8* %29, i8* %44, i32 %38) #9
...
; <label>:48:                                     ; preds = %4, %28, %42
  ...
  %67 = load i8, i8* %66, align 4, !tbaa !76, !noalias !244
  %68 = and i8 %67, 1
  %69 = icmp eq i8 %68, 0
  ...
  %71 = load i32, i32* %70, align 4, !noalias !244
  %72 = lshr i8 %67, 1
...
; <label>:85:                                     ; preds = %82
  ...
  call void @_ZNSt3__16vectorIcNS_9allocatorIcEEE8__appendEj(%"class.std::__1::vector.104"* nonnull %61, i32 %83) #9
  %87 = load i8*, i8** %62, align 4, !tbaa !241, !alias.scope !244
  %88 = load i32, i32* %86, align 4, !tbaa !247, !alias.scope !244
  br label %89
...
; <label>:89:                                     ; preds = %82, %85
  ...
  store i8* %98, i8** %97, align 4, !tbaa !42, !noalias !244
  %99 = bitcast %class.anon.128* %8 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %99) #10, !noalias !244
  %100 = getelementptr inbounds %class.anon.128, %class.anon.128* %8, i32 0, i32 0
  store %"class.eosio::datastream.79"* %9, %"class.eosio::datastream.79"** %100, align 4, !tbaa !43, !noalias !244
  %101 = bitcast %"struct.boost::fusion::std_tuple_iterator"* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %101) #10, !noalias !244
  %102 = getelementptr inbounds %"struct.boost::fusion::std_tuple_iterator", %"struct.boost::fusion::std_tuple_iterator"* %7, i32 0, i32 0
  store %"class.std::__1::tuple"* %3, %"class.std::__1::tuple"** %102, align 4, !noalias !244
  call void @_ZN5boost6fusion6detail17for_each_unrolledILi4EE4callINS0_18std_tuple_iteratorIKNSt3__15tupleIJN5eosio4nameES9_NS8_5assetENS6_12basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEEEEELi0EEEZNS8_lsINS8_10datastreamIPcEEJS9_S9_SA_SG_EEERT_SP_RKNS7_IJDpT0_EEEEUlRKSO_E_EEvSW_RKT0_(%"struct.boost::fusion::std_tuple_iterator"* nonnull dereferenceable(4) %7, %class.anon.128* nonnull dereferenceable(4) %8) #9
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %101) #10, !noalias !244
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %99) #10, !noalias !244
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %92) #10, !noalias !244
  ...
  store i8* null, i8** %104, align 4, !tbaa !241, !alias.scope !250
  %105 = getelementptr inbounds %"class.std::__1::vector.104", %"class.std::__1::vector.104"* %6, i32 0, i32 0, i32 1
  store i8* null, i8** %105, align 4, !tbaa !247, !alias.scope !250
  %106 = getelementptr inbounds %"class.std::__1::vector.104", %"class.std::__1::vector.104"* %6, i32 0, i32 0, i32 2, i32 0, i32 0
  store i8* null, i8** %106, align 4, !tbaa !248, !alias.scope !250
  %107 = load i32, i32* %59, align 4, !tbaa !75, !noalias !250
  %108 = load i32, i32* %57, align 8, !tbaa !72, !noalias !250
  %109 = sub i32 %107, %108
...
; <label>:131:                                    ; preds = %122, %118
  ...
  %134 = load i32, i32* %133, align 4, !tbaa !247, !noalias !250
  %135 = bitcast %"class.std::__1::vector.104"* %61 to i32*
  %136 = load i32, i32* %135, align 4, !tbaa !241, !noalias !250
  %137 = sub i32 %134, %136
...
; <label>:149:                                    ; preds = %145
  call void @_ZNSt3__16vectorIcNS_9allocatorIcEEE8__appendEj(%"class.std::__1::vector.104"* nonnull %6, i32 %146) #9
  %150 = load i8*, i8** %104, align 4, !tbaa !241, !alias.scope !250
  %151 = load i32, i32* %148, align 4, !tbaa !247, !alias.scope !250
  br label %152
...
; <label>:152:                                    ; preds = %145, %149
  ...
  store i8* %161, i8** %160, align 4, !tbaa !42, !noalias !250
  %162 = call dereferenceable(12) %"class.eosio::datastream.79"* @_ZN5eosiolsINS_10datastreamIPcEEEERT_S5_RKNS_6actionE(%"class.eosio::datastream.79"* nonnull dereferenceable(12) %5, %"struct.eosio::action"* nonnull dereferenceable(40) %10) #9
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %155) #10, !noalias !250
  %163 = load i8*, i8** %104, align 4, !tbaa !241
  %164 = load i32, i32* %148, align 4, !tbaa !247
  %165 = ptrtoint i8* %163 to i32
  %166 = sub i32 %164, %165
  call void @send_inline(i8* %163, i32 %166) #9
  %167 = load i8*, i8** %104, align 4, !tbaa !241
  %168 = icmp eq i8* %167, null
  br i1 %168, label %171, label %169

; <label>:169:                                    ; preds = %152
  %170 = ptrtoint i8* %167 to i32
  store i32 %170, i32* %148, align 4, !tbaa !247
...
; <label>:171:                                    ; preds = %152, %169
  ...
  %173 = load i8*, i8** %172, align 4, !tbaa !241
  %174 = icmp eq i8* %173, null
  br i1 %174, label %177, label %175

; <label>:175:                                    ; preds = %171
  %176 = ptrtoint i8* %173 to i32
  store i32 %176, i32* %133, align 4, !tbaa !247
...
; <label>:13:                                     ; preds = %13, %11
  ...
  %16 = load i8*, i8** %6, align 4, !tbaa !247
  %17 = getelementptr inbounds i8, i8* %16, i32 1
  store i8* %17, i8** %6, align 4, !tbaa !247
  %18 = add i32 %15, -1
  %19 = icmp eq i32 %18, 0
...
; <label>:20:                                     ; preds = %2
  ...
  %22 = load i32, i32* %21, align 4, !tbaa !241
  %23 = sub i32 %8, %22
  %24 = add i32 %23, %1
  %25 = icmp slt i32 %24, 0
  br i1 %25, label %26, label %28
...
; <label>:52:                                     ; preds = %46
  ...
  %57 = load i8*, i8** %56, align 4, !tbaa !241
  %58 = load i32, i32* %7, align 4, !tbaa !247
...
define linkonce_odr hidden void @_ZN5boost6fusion6detail17for_each_unrolledILi4EE4callINS0_18std_tuple_iteratorIKNSt3__15tupleIJN5eosio4nameES9_NS8_5assetENS6_12basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEEEEELi0EEEZNS8_lsINS8_10datastreamIPcEEJS9_S9_SA_SG_EEERT_SP_RKNS7_IJDpT0_EEEEUlRKSO_E_EEvSW_RKT0_(%"struct.boost::fusion::std_tuple_iterator"* dereferenceable(4), %class.anon.128* dereferenceable(4)) local_unnamed_addr #0 comdat {
  ...
  %5 = load i8*, i8** %4, align 4, !tbaa !253
  %6 = getelementptr inbounds %class.anon.128, %class.anon.128* %1, i32 0, i32 0
  %7 = load %"class.eosio::datastream.79"*, %"class.eosio::datastream.79"** %6, align 4, !tbaa !255
...
; <label>:19:                                     ; preds = %2, %17
  ...
  %21 = tail call i8* @memcpy(i8* %20, i8* nonnull %5, i32 8) #9
  ...
  %25 = load %"class.std::__1::tuple"*, %"class.std::__1::tuple"** %24, align 4, !tbaa !253
  %26 = getelementptr inbounds %"class.std::__1::tuple", %"class.std::__1::tuple"* %25, i32 0, i32 0, i32 1, i32 0
  %27 = load %"class.eosio::datastream.79"*, %"class.eosio::datastream.79"** %6, align 4, !tbaa !255
...
; <label>:40:                                     ; preds = %19, %38
  ...
  %42 = tail call i8* @memcpy(i8* %41, i8* nonnull %28, i32 8) #9
  ...
  %46 = load %"class.eosio::datastream.79"*, %"class.eosio::datastream.79"** %6, align 4, !tbaa !255
...
; <label>:59:                                     ; preds = %57, %40
  ...
  %61 = tail call i8* @memcpy(i8* %60, i8* nonnull %47, i32 8) #9
...
; <label>:73:                                     ; preds = %59, %71
  ...
  %75 = call i8* @memcpy(i8* %74, i8* nonnull %66, i32 8) #9
  ...
  %79 = load %"class.eosio::datastream.79"*, %"class.eosio::datastream.79"** %6, align 4, !tbaa !255
  %80 = call dereferenceable(12) %"class.eosio::datastream.79"* @_ZN5eosiolsINS_10datastreamIPcEEEERT_S5_RKNSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEE(%"class.eosio::datastream.79"* dereferenceable(12) %79, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %78) #9
  ret void
}
...
; <label>:35:                                     ; preds = %33, %19
  ...
  %37 = call i8* @memcpy(i8* %36, i8* nonnull %3, i32 1) #9
...
; <label>:63:                                     ; preds = %51, %61
  ...
  %65 = call i8* @memcpy(i8* %64, i8* %57, i32 %49) #9
...
; <label>:15:                                     ; preds = %2, %13
  ...
  %17 = tail call i8* @memcpy(i8* %16, i8* nonnull %3, i32 8) #9
...
; <label>:28:                                     ; preds = %15, %26
  ...
  %30 = tail call i8* @memcpy(i8* %29, i8* nonnull %21, i32 8) #9
  ...
  %34 = tail call dereferenceable(12) %"class.eosio::datastream.79"* @_ZN5eosiolsINS_10datastreamIPcEENS_16permission_levelEEERT_S6_RKNSt3__16vectorIT0_NS7_9allocatorIS9_EEEE(%"class.eosio::datastream.79"* nonnull dereferenceable(12) %0, %"class.std::__1::vector.8"* nonnull dereferenceable(12) %33) #12
  %35 = getelementptr inbounds %"struct.eosio::action", %"struct.eosio::action"* %1, i32 0, i32 3
  %36 = tail call dereferenceable(12) %"class.eosio::datastream.79"* @_ZN5eosiolsINS_10datastreamIPcEEEERT_S5_RKNSt3__16vectorIcNS6_9allocatorIcEEEE(%"class.eosio::datastream.79"* nonnull dereferenceable(12) %34, %"class.std::__1::vector.104"* nonnull dereferenceable(12) %35) #12
...
define linkonce_odr hidden dereferenceable(12) %"class.eosio::datastream.79"* @_ZN5eosiolsINS_10datastreamIPcEEEERT_S5_RKNSt3__16vectorIcNS6_9allocatorIcEEEE(%"class.eosio::datastream.79"* dereferenceable(12), %"class.std::__1::vector.104"* dereferenceable(12)) local_unnamed_addr #0 comdat {
  ...
  %5 = bitcast i8** %4 to i32*
  %6 = load i32, i32* %5, align 4, !tbaa !247
  %7 = bitcast %"class.std::__1::vector.104"* %1 to i32*
  %8 = load i32, i32* %7, align 4, !tbaa !241
  %9 = sub i32 %6, %8
...
; <label>:39:                                     ; preds = %32
  ...
  %42 = load i8*, i8** %41, align 4, !tbaa !241
  %43 = load i32, i32* %5, align 4, !tbaa !247
...
; <label>:51:                                     ; preds = %39, %49
  ...
  %53 = call i8* @memcpy(i8* %52, i8* %42, i32 %45) #9
...
; <label>:33:                                     ; preds = %31, %17
  ...
  %35 = call i8* @memcpy(i8* %34, i8* nonnull %3, i32 1) #9
...
; <label>:56:                                     ; preds = %54, %46
  ...
  %58 = call i8* @memcpy(i8* %57, i8* nonnull %50, i32 8) #9
...
define linkonce_odr hidden dereferenceable(32) %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* @_ZNK5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE31load_object_by_primary_iteratorEi(%"class.eosio::multi_index.19"*, i32) local_unnamed_addr #0 comdat {
  ...
  %9 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %8, align 4, !tbaa !97, !noalias !257
  %10 = getelementptr inbounds %"class.std::__1::vector.20", %"class.std::__1::vector.20"* %7, i32 0, i32 0, i32 0
  %11 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %10, align 4, !tbaa !94, !noalias !260
...
; <label>:13:                                     ; preds = %2, %18
  ...
  %16 = load i32, i32* %15, align 8, !tbaa !122, !noalias !263
  %17 = icmp eq i32 %16, %1
...
; <label>:32:                                     ; preds = %29, %30
  %33 = tail call i8* @malloc(i32 %27) #9
  br label %36
...
; <label>:49:                                     ; preds = %48, %36
  %50 = call i8* @memcpy(i8* nonnull %41, i8* %38, i32 8) #9
...
; <label>:56:                                     ; preds = %49, %55
  %57 = call i8* @memcpy(i8* nonnull %52, i8* nonnull %51, i32 8) #9
  ...
  store i32 %61, i32* %62, align 4, !tbaa !115, !alias.scope !266
...
; <label>:77:                                     ; preds = %56
  call void @_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS7_4itemENS_14default_deleteISE_EEEERyRiEEEvDpOT_(%"class.std::__1::vector.20"* nonnull %7, %"class.std::__1::unique_ptr.36"* nonnull dereferenceable(4) %4, i64* nonnull dereferenceable(8) %5, i32* nonnull dereferenceable(4) %6) #9
  br label %78
...
; Function Attrs: nounwind
define internal fastcc void @"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE6modifyIZNS3_11add_balanceES1_NS_5assetES1_E3$_5EEvRKS4_S1_OT_"(%"class.eosio::multi_index.19"*, %"struct.eosio::token::account"* dereferenceable(16), %class.anon.31* nocapture readonly dereferenceable(4)) unnamed_addr #0 {
  %4 = alloca i64, align 8
...
; <label>:17:                                     ; preds = %11, %16
  ...
  %22 = load %"struct.eosio::asset"*, %"struct.eosio::asset"** %21, align 4, !tbaa !269
...
; <label>:45:                                     ; preds = %44, %40
  ...
  call void @db_update_i64(i32 %55, i64 0, i8* nonnull %47, i32 16) #9
...
define internal fastcc void @"_ZZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE7emplaceIZNS3_4openES1_RKNS_6symbolES1_E3$_6EENS5_14const_iteratorES1_OT_ENKUlRSC_E_clINS5_4itemEEEDaSE_"(%class.anon.171* nocapture readonly, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"* dereferenceable(32)) unnamed_addr #8 {
  %3 = alloca i64, align 8
  ...
  %7 = load %class.anon.32*, %class.anon.32** %6, align 4, !tbaa !271
  %8 = getelementptr %class.anon.32, %class.anon.32* %7, i32 0, i32 0
  %9 = load %"class.eosio::symbol"*, %"class.eosio::symbol"** %8, align 4, !tbaa !272
...
; <label>:38:                                     ; preds = %13, %24
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.20, i32 0, i32 0)) #9
  br label %39
...
; <label>:39:                                     ; preds = %33, %38
  ...
  %45 = call i8* @memcpy(i8* nonnull %43, i8* nonnull %44, i32 8) #9
  ...
  %49 = call i8* @memcpy(i8* nonnull %46, i8* nonnull %48, i32 8) #9
  ...
  %55 = load %"struct.eosio::name"*, %"struct.eosio::name"** %54, align 4, !tbaa !274
  %56 = getelementptr inbounds %"struct.eosio::name", %"struct.eosio::name"* %55, i32 0, i32 0
  %57 = load i64, i64* %56, align 8, !tbaa !31
  %58 = call i32 @db_store_i64(i64 %53, i64 3607749779137757184, i64 %57, i64 %51, i8* nonnull %43, i32 16) #9
...
; Function Attrs: nounwind
define linkonce_odr hidden void @_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE5eraseERKS4_(%"class.eosio::multi_index.19"*, %"struct.eosio::token::account"* dereferenceable(16)) local_unnamed_addr #0 comdat {
  ...
  %5 = bitcast %"struct.eosio::token::account"* %4 to %"class.eosio::multi_index.19"**
...
; <label>:8:                                      ; preds = %2
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.23, i32 0, i32 0)) #9
  br label %9

; <label>:9:                                      ; preds = %2, %8
  %10 = tail call i64 @current_receiver() #9
...
; <label>:14:                                     ; preds = %9
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.24, i32 0, i32 0)) #9
  br label %15
...
; <label>:15:                                     ; preds = %9, %14
  ...
  %20 = load i32, i32* %19, align 4, !tbaa !97, !noalias !275
  %21 = getelementptr inbounds %"class.eosio::multi_index.19", %"class.eosio::multi_index.19"* %0, i32 0, i32 3, i32 0, i32 0
  %22 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item_ptr"** %21, align 4, !tbaa !94, !noalias !278
...
; <label>:25:                                     ; preds = %15
  ...
  %28 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %27, align 4, !tbaa !43, !noalias !281
  ...
  %30 = load i64, i64* %29, align 8, !tbaa !55, !noalias !281
  %31 = xor i64 %30, %17
...
; <label>:33:                                     ; preds = %41
  ...
  %36 = load %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"*, %"struct.eosio::multi_index<3607749779137757184, eosio::token::account>::item"** %35, align 4, !tbaa !43, !noalias !281
  ...
  %38 = load i64, i64* %37, align 8, !tbaa !55, !noalias !281
  %39 = xor i64 %38, %17
...
; <label>:50:                                     ; preds = %41, %15, %46
  ...
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.25, i32 0, i32 0)) #9
...
; <label>:70:                                     ; preds = %68, %58
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %73, i8* nonnull align 8 %74, i64 12, i1 false) #10
...
; <label>:94:                                     ; preds = %92, %78
  ...
  tail call void @db_remove_i64(i32 %97) #9
  ret void
}
...
define linkonce_odr hidden void @_ZN5boost6fusion6detail17for_each_unrolledILi2EE4callINS0_18std_tuple_iteratorINSt3__15tupleIJN5eosio4nameENS8_5assetEEEELi0EEEZNS8_rsINS8_10datastreamIPKcEEJS9_SA_EEERT_SJ_RNS7_IJDpT0_EEEEUlSJ_E_EEvRKSI_RKT0_(%"struct.boost::fusion::std_tuple_iterator.183"* dereferenceable(4), %class.anon.182* dereferenceable(4)) local_unnamed_addr #0 comdat {
  ...
  %5 = load i8*, i8** %4, align 4, !tbaa !284
  %6 = getelementptr inbounds %class.anon.182, %class.anon.182* %1, i32 0, i32 0
  %7 = load %"class.eosio::datastream"*, %"class.eosio::datastream"** %6, align 4, !tbaa !286
...
; <label>:19:                                     ; preds = %2, %17
  %20 = phi i8* [ %16, %2 ], [ %18, %17 ]
  %21 = tail call i8* @memcpy(i8* nonnull %5, i8* %20, i32 8) #9
  ...
  %25 = load %"class.std::__1::tuple.178"*, %"class.std::__1::tuple.178"** %24, align 4, !tbaa !284
  %26 = getelementptr inbounds %"class.std::__1::tuple.178", %"class.std::__1::tuple.178"* %25, i32 0, i32 0, i32 1, i32 0
  %27 = load %"class.eosio::datastream"*, %"class.eosio::datastream"** %6, align 4, !tbaa !286
...
; <label>:40:                                     ; preds = %38, %19
  %41 = phi i8* [ %37, %19 ], [ %39, %38 ]
  %42 = tail call i8* @memcpy(i8* nonnull %28, i8* %41, i32 8) #9
...
; <label>:52:                                     ; preds = %40, %50
  ...
  %54 = call i8* @memcpy(i8* nonnull %45, i8* %53, i32 8) #9
...
define linkonce_odr hidden dereferenceable(12) %"class.eosio::datastream"* @_ZN5eosiorsINS_10datastreamIPKcEEEERT_S6_RNSt3__112basic_stringIcNS7_11char_traitsIcEENS7_9allocatorIcEEEE(%"class.eosio::datastream"* dereferenceable(12), %"class.std::__1::basic_string"* dereferenceable(12)) local_unnamed_addr #0 comdat {
  ...
  store i8* null, i8** %6, align 4, !tbaa !241
  %7 = getelementptr inbounds %"class.std::__1::vector.104", %"class.std::__1::vector.104"* %3, i32 0, i32 0, i32 1
  store i8* null, i8** %7, align 4, !tbaa !247
  %8 = getelementptr inbounds %"class.std::__1::vector.104", %"class.std::__1::vector.104"* %3, i32 0, i32 0, i32 2, i32 0, i32 0
  store i8* null, i8** %8, align 4, !tbaa !248
  %9 = call dereferenceable(12) %"class.eosio::datastream"* @_ZN5eosiorsINS_10datastreamIPKcEEEERT_S6_RNSt3__16vectorIcNS7_9allocatorIcEEEE(%"class.eosio::datastream"* nonnull dereferenceable(12) %0, %"class.std::__1::vector.104"* nonnull dereferenceable(12) %3) #12
  %10 = bitcast i8** %7 to i32*
  %11 = load i32, i32* %10, align 4, !tbaa !247
  %12 = bitcast %"class.std::__1::vector.104"* %3 to i32*
  %13 = load i32, i32* %12, align 4, !tbaa !241
  %14 = sub i32 %11, %13
  %15 = icmp eq i32 %14, 0
  %16 = inttoptr i32 %13 to i8*
...
; <label>:17:                                     ; preds = %2
  ...
  call void @llvm.memset.p0i8.i32(i8* nonnull align 4 %18, i8 0, i32 12, i1 false) #10
  %20 = icmp ugt i32 %14, -17
  br i1 %20, label %21, label %23

; <label>:21:                                     ; preds = %17
  %22 = bitcast %"class.std::__1::basic_string"* %4 to %"class.std::__1::__basic_string_common"*
  call void @_ZNKSt3__121__basic_string_commonILb1EE20__throw_length_errorEv(%"class.std::__1::__basic_string_common"* nonnull %22) #13
  unreachable
...
; <label>:60:                                     ; preds = %57, %53
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 4 %49, i8* nonnull align 4 %18, i32 12, i1 false) #10, !tbaa.struct !288
...
; <label>:80:                                     ; preds = %75, %60
  %81 = load i8*, i8** %6, align 4, !tbaa !241
  %82 = icmp eq i8* %81, null
  br i1 %82, label %85, label %83

; <label>:83:                                     ; preds = %80
  %84 = ptrtoint i8* %81 to i32
  store i32 %84, i32* %10, align 4, !tbaa !247
...
; <label>:12:                                     ; preds = %6
  tail call void @eosio_assert(i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.26, i32 0, i32 0)) #9
...
; <label>:27:                                     ; preds = %14
  ...
  %34 = load i32, i32* %33, align 4, !tbaa !241
  %35 = sub i32 %32, %34
...
; <label>:38:                                     ; preds = %27
  %39 = sub i32 %29, %35
  tail call void @_ZNSt3__16vectorIcNS_9allocatorIcEEE8__appendEj(%"class.std::__1::vector.104"* nonnull %1, i32 %39) #9
  %40 = getelementptr inbounds %"class.std::__1::vector.104", %"class.std::__1::vector.104"* %1, i32 0, i32 0, i32 0
  %41 = load i8*, i8** %40, align 4, !tbaa !241
  %42 = load i32, i32* %31, align 4, !tbaa !247
...
; <label>:47:                                     ; preds = %45
  ...
  store i8* %48, i8** %30, align 4, !tbaa !247
...
; <label>:63:                                     ; preds = %50, %61
  ...
  %65 = tail call i8* @memcpy(i8* %53, i8* %64, i32 %55) #9
...
define linkonce_odr hidden void @_ZN5boost4mp116detail16tuple_apply_implIRZN5eosio14execute_actionINS3_5tokenEJNS3_4nameENS3_5assetENSt3__112basic_stringIcNS8_11char_traitsIcEENS8_9allocatorIcEEEEEEEbS6_S6_MT_FvDpT0_EEUlDpT_E_RNS8_5tupleIJS6_S7_SE_EEEJLj0ELj1ELj2EEEEDTclclsr3stdE7forwardISF_Efp_Espclsr3stdE3getIXT1_EEclsr3stdE7forwardIT0_Efp0_EEEEOSF_OSR_NS0_16integer_sequenceIjJXspT1_EEEE(%class.anon.193* dereferenceable(8), %"class.std::__1::tuple.189"* dereferenceable(40)) local_unnamed_addr #0 comdat {
  ...
  %14 = call %"class.std::__1::basic_string"* @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC1ERKS5_(%"class.std::__1::basic_string"* nonnull %7, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %13) #9
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %15, i8* nonnull align 8 %11, i64 16, i1 false) #10
...
; <label>:39:                                     ; preds = %37, %31
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %16, i8* nonnull align 8 %15, i32 16, i1 false) #10, !tbaa.struct !38
  %41 = call %"class.std::__1::basic_string"* @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC1ERKS5_(%"class.std::__1::basic_string"* nonnull %4, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %7) #9
  call void %40(%"class.eosio::token"* %28, i64 %9, %"struct.eosio::asset"* byval nonnull align 8 %3, %"class.std::__1::basic_string"* nonnull %4) #9
...
; <label>:59:                                     ; preds = %57, %40
  %60 = phi i8* [ %56, %40 ], [ %58, %57 ]
  %61 = tail call i8* @memcpy(i8* nonnull %47, i8* %60, i32 8) #9
...
; <label>:71:                                     ; preds = %59, %69
  ...
  %73 = call i8* @memcpy(i8* nonnull %64, i8* %72, i32 8) #9
  ...
  %80 = call dereferenceable(12) %"class.eosio::datastream"* @_ZN5eosiorsINS_10datastreamIPKcEEEERT_S6_RNSt3__112basic_stringIcNS7_11char_traitsIcEENS7_9allocatorIcEEEE(%"class.eosio::datastream"* dereferenceable(12) %79, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %78) #9
  ret void
}
...
define linkonce_odr hidden void @_ZN5boost4mp116detail16tuple_apply_implIRZN5eosio14execute_actionINS3_5tokenEJNS3_4nameES6_NS3_5assetENSt3__112basic_stringIcNS8_11char_traitsIcEENS8_9allocatorIcEEEEEEEbS6_S6_MT_FvDpT0_EEUlDpT_E_RNS8_5tupleIJS6_S6_S7_SE_EEEJLj0ELj1ELj2ELj3EEEEDTclclsr3stdE7forwardISF_Efp_Espclsr3stdE3getIXT1_EEclsr3stdE7forwardIT0_Efp0_EEEEOSF_OSR_NS0_16integer_sequenceIjJXspT1_EEEE(%class.anon.205* dereferenceable(8), %"class.std::__1::tuple"* dereferenceable(48)) local_unnamed_addr #0 comdat {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %17, i8* nonnull align 8 %13, i64 16, i1 false) #10
...
; <label>:41:                                     ; preds = %39, %33
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %18, i8* nonnull align 8 %17, i32 16, i1 false) #10, !tbaa.struct !38
  %43 = call %"class.std::__1::basic_string"* @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC1ERKS5_(%"class.std::__1::basic_string"* nonnull %4, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %7) #9
  call void %42(%"class.eosio::token"* %30, i64 %9, i64 %11, %"struct.eosio::asset"* byval nonnull align 8 %3, %"class.std::__1::basic_string"* nonnull %4) #9
...
; <label>:39:                                     ; preds = %19, %37
  ...
  %41 = call i8* @memcpy(i8* nonnull %27, i8* %40, i32 8) #9
...
; <label>:60:                                     ; preds = %39, %58
  ...
  %62 = call i8* @memcpy(i8* nonnull %48, i8* %61, i32 8) #9
...
; <label>:20:                                     ; preds = %18, %2
  ...
  %22 = tail call i8* @memcpy(i8* nonnull %8, i8* %21, i32 8) #9
...
; <label>:32:                                     ; preds = %20, %30
  ...
  %34 = call i8* @memcpy(i8* nonnull %25, i8* %33, i32 8) #9
  ...
  %42 = call dereferenceable(12) %"class.eosio::datastream"* @_ZN5eosiorsINS_10datastreamIPKcEEEERT_S6_RNSt3__112basic_stringIcNS7_11char_traitsIcEENS7_9allocatorIcEEEE(%"class.eosio::datastream"* dereferenceable(12) %41, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %40) #9
  ret void
}

; Function Attrs: nounwind
define linkonce_odr hidden void @_ZN5boost4mp116detail16tuple_apply_implIRZN5eosio14execute_actionINS3_5tokenEJNS3_5assetENSt3__112basic_stringIcNS7_11char_traitsIcEENS7_9allocatorIcEEEEEEEbNS3_4nameESE_MT_FvDpT0_EEUlDpT_E_RNS7_5tupleIJS6_SD_EEEJLj0ELj1EEEEDTclclsr3stdE7forwardISF_Efp_Espclsr3stdE3getIXT1_EEclsr3stdE7forwardIT0_Efp0_EEEEOSF_OSR_NS0_16integer_sequenceIjJXspT1_EEEE(%class.anon.253* dereferenceable(8), %"class.std::__1::tuple.248"* dereferenceable(32)) local_unnamed_addr #0 comdat {
  %3 = alloca %"struct.eosio::asset", align 8
  %4 = alloca %"class.std::__1::basic_string", align 4
  %5 = alloca %"struct.eosio::asset", align 8
  %6 = alloca %"struct.eosio::asset", align 8
  ...
  %11 = call %"class.std::__1::basic_string"* @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC1ERKS5_(%"class.std::__1::basic_string"* nonnull %7, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %10) #9
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %12, i8* nonnull align 8 %8, i64 16, i1 false) #10
  ...
  %25 = bitcast i8* %24 to %"class.eosio::token"*
  %26 = and i32 %22, 1
  %27 = icmp eq i32 %26, 0
...
; <label>:28:                                     ; preds = %2
  ...
  %32 = bitcast i8* %31 to void (%"class.eosio::token"*, %"struct.eosio::asset"*, %"class.std::__1::basic_string"*)**
  %33 = load void (%"class.eosio::token"*, %"struct.eosio::asset"*, %"class.std::__1::basic_string"*)*, void (%"class.eosio::token"*, %"struct.eosio::asset"*, %"class.std::__1::basic_string"*)** %32, align 4
  br label %36

; <label>:34:                                     ; preds = %2
  %35 = inttoptr i32 %20 to void (%"class.eosio::token"*, %"struct.eosio::asset"*, %"class.std::__1::basic_string"*)*
  br label %36

; <label>:36:                                     ; preds = %34, %28
  %37 = phi void (%"class.eosio::token"*, %"struct.eosio::asset"*, %"class.std::__1::basic_string"*)* [ %33, %28 ], [ %35, %34 ]
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 8 %13, i8* nonnull align 8 %12, i32 16, i1 false) #10, !tbaa.struct !38
  %38 = call %"class.std::__1::basic_string"* @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEC1ERKS5_(%"class.std::__1::basic_string"* nonnull %4, %"class.std::__1::basic_string"* nonnull dereferenceable(12) %7) #9
  call void %37(%"class.eosio::token"* %25, %"struct.eosio::asset"* byval nonnull align 8 %3, %"class.std::__1::basic_string"* nonnull %4) #9
...
!108 = !{!109}
!109 = distinct !{!109, !110, !"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE7emplaceIZNS3_11add_balanceES1_NS_5assetES1_E3$_4EENS5_14const_iteratorES1_OT_: argument 0"}
!110 = distinct !{!110, !"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE7emplaceIZNS3_11add_balanceES1_NS_5assetES1_E3$_4EENS5_14const_iteratorES1_OT_"}
!111 = !{!112, !109}
!112 = distinct !{!112, !113, !"_ZNSt3__111make_uniqueIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE4itemEJPS7_ZNS7_7emplaceIZNS5_11add_balanceES3_NS1_5assetES3_E3$_4EENS7_14const_iteratorES3_OT_EUlRSE_E_EEENS_11__unique_ifISE_E15__unique_singleEDpOT0_: argument 0"}
!113 = distinct !{!113, !"_ZNSt3__111make_uniqueIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE4itemEJPS7_ZNS7_7emplaceIZNS5_11add_balanceES3_NS1_5assetES3_E3$_4EENS7_14const_iteratorES3_OT_EUlRSE_E_EEENS_11__unique_ifISE_E15__unique_singleEDpOT0_"}
!114 = !{!104, !24, i64 20}
!115 = !{!116, !14, i64 0}
...
!129 = !{!130, !14, i64 0}
!130 = !{!"_ZTSZN5eosio5token6retireENS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEEE3$_2", !14, i64 0}
...
!148 = !{!149, !151}
!149 = distinct !{!149, !150, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE6rbeginEv: argument 0"}
!150 = distinct !{!150, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE6rbeginEv"}
!151 = distinct !{!151, !152, !"_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE4findEy: argument 0"}
!152 = distinct !{!152, !"_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE4findEy"}
!153 = !{!154, !151}
!154 = distinct !{!154, !155, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE4rendEv: argument 0"}
!155 = distinct !{!155, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE4rendEv"}
!156 = !{!157, !151}
!157 = distinct !{!157, !158, !"_ZNSt3__17find_ifINS_16reverse_iteratorINS_11__wrap_iterIPN5eosio11multi_indexILNS3_4name3rawE14289235522390851584ENS3_5token14currency_statsEJEE8item_ptrEEEEEZNKS9_4findEyEUlRKSA_E_EET_SH_SH_T0_: argument 0"}
!158 = distinct !{!158, !"_ZNSt3__17find_ifINS_16reverse_iteratorINS_11__wrap_iterIPN5eosio11multi_indexILNS3_4name3rawE14289235522390851584ENS3_5token14currency_statsEJEE8item_ptrEEEEEZNKS9_4findEyEUlRKSA_E_EET_SH_SH_T0_"}
!159 = !{!160, !151}
!160 = distinct !{!160, !161, !"_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE11iterator_toERKS4_: argument 0"}
!161 = distinct !{!161, !"_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE11iterator_toERKS4_"}
!162 = !{!7, !3, i64 0}
!163 = !{!151}
!164 = !{!165, !151}
!165 = distinct !{!165, !166, !"_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE11iterator_toERKS4_: argument 0"}
!166 = distinct !{!166, !"_ZNK5eosio11multi_indexILNS_4name3rawE14289235522390851584ENS_5token14currency_statsEJEE11iterator_toERKS4_"}
!167 = !{!168, !14, i64 0}
!168 = !{!"_ZTSZN5eosio5token11sub_balanceENS_4nameENS_5assetEE3$_3", !14, i64 0}
!169 = !{!170}
!170 = distinct !{!170, !171, !"_ZNK5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE4findEy: argument 0"}
!171 = distinct !{!171, !"_ZNK5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE4findEy"}
!172 = !{!173, !170}
...
!175 = !{!176}
!176 = distinct !{!176, !177, !"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE7emplaceIZNS3_4openES1_RKNS_6symbolES1_E3$_6EENS5_14const_iteratorES1_OT_: argument 0"}
!177 = distinct !{!177, !"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE7emplaceIZNS3_4openES1_RKNS_6symbolES1_E3$_6EENS5_14const_iteratorES1_OT_"}
!178 = !{!179, !14, i64 0}
!179 = !{!"_ZTSZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE7emplaceIZNS3_4openES1_RKNS_6symbolES1_E3$_6EENS5_14const_iteratorES1_OT_EUlRSC_E_", !14, i64 0, !14, i64 4, !14, i64 8}
!180 = !{!181, !176}
!181 = distinct !{!181, !182, !"_ZNSt3__111make_uniqueIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE4itemEJPS7_ZNS7_7emplaceIZNS5_4openES3_RKNS1_6symbolES3_E3$_6EENS7_14const_iteratorES3_OT_EUlRSG_E_EEENS_11__unique_ifISG_E15__unique_singleEDpOT0_: argument 0"}
!182 = distinct !{!182, !"_ZNSt3__111make_uniqueIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE4itemEJPS7_ZNS7_7emplaceIZNS5_4openES3_RKNS1_6symbolES3_E3$_6EENS7_14const_iteratorES3_OT_EUlRSG_E_EEENS_11__unique_ifISG_E15__unique_singleEDpOT0_"}
!183 = !{!181}
!184 = !{!185}
...
!190 = !{!191}
!191 = distinct !{!191, !192, !"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE5eraseENS5_14const_iteratorE: argument 0"}
!192 = distinct !{!192, !"_ZN5eosio11multi_indexILNS_4name3rawE3607749779137757184ENS_5token7accountEJEE5eraseENS5_14const_iteratorE"}
!193 = !{!194, !14, i64 0}
...
!200 = !{!201}
!201 = distinct !{!201, !202, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE6rbeginEv: argument 0"}
!202 = distinct !{!202, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE6rbeginEv"}
!203 = !{!204}
!204 = distinct !{!204, !205, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE4rendEv: argument 0"}
!205 = distinct !{!205, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE8item_ptrENS_9allocatorIS8_EEE4rendEv"}
!206 = !{!207}
!207 = distinct !{!207, !208, !"_ZNSt3__17find_ifINS_16reverse_iteratorINS_11__wrap_iterIPN5eosio11multi_indexILNS3_4name3rawE14289235522390851584ENS3_5token14currency_statsEJEE8item_ptrEEEEEZNKS9_31load_object_by_primary_iteratorEiEUlRKSA_E_EET_SH_SH_T0_: argument 0"}
!208 = distinct !{!208, !"_ZNSt3__17find_ifINS_16reverse_iteratorINS_11__wrap_iterIPN5eosio11multi_indexILNS3_4name3rawE14289235522390851584ENS3_5token14currency_statsEJEE8item_ptrEEEEEZNKS9_31load_object_by_primary_iteratorEiEUlRKSA_E_EET_SH_SH_T0_"}
!209 = !{!210}
!210 = distinct !{!210, !211, !"_ZNSt3__111make_uniqueIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE4itemEJPKS7_ZNKS7_31load_object_by_primary_iteratorEiEUlRT_E_EEENS_11__unique_ifISB_E15__unique_singleEDpOT0_: argument 0"}
!211 = distinct !{!211, !"_ZNSt3__111make_uniqueIN5eosio11multi_indexILNS1_4name3rawE14289235522390851584ENS1_5token14currency_statsEJEE4itemEJPKS7_ZNKS7_31load_object_by_primary_iteratorEiEUlRT_E_EEENS_11__unique_ifISB_E15__unique_singleEDpOT0_"}
!212 = !{!213, !215, !217, !219, !221}
!213 = distinct !{!213, !214, !"_ZN5boost3pfr6detail28tie_as_tuple_with_referencesIJN5eosio5assetES4_NS3_4nameEEEEDaDpRT_: argument 0"}
!214 = distinct !{!214, !"_ZN5boost3pfr6detail28tie_as_tuple_with_referencesIJN5eosio5assetES4_NS3_4nameEEEEDaDpRT_"}
!215 = distinct !{!215, !216, !"_ZN5boost3pfr6detail17my_tuple_cat_implINS1_14sequence_tuple5tupleIJRN5eosio5assetEEEEJLj0EENS4_IJS7_RNS5_4nameEEEEJLj0ELj1EEEEDaRKT_NSt3__116integer_sequenceIjJXspT0_EEEERKT1_NSG_IjJXspT2_EEEE: argument 0"}
!216 = distinct !{!216, !"_ZN5boost3pfr6detail17my_tuple_cat_implINS1_14sequence_tuple5tupleIJRN5eosio5assetEEEEJLj0EENS4_IJS7_RNS5_4nameEEEEJLj0ELj1EEEEDaRKT_NSt3__116integer_sequenceIjJXspT0_EEEERKT1_NSG_IjJXspT2_EEEE"}
!217 = distinct !{!217, !218, !"_ZN5boost3pfr6detail12my_tuple_catINS1_14sequence_tuple5tupleIJRN5eosio5assetEEEENS4_IJS7_RNS5_4nameEEEEEEDaRKT_RKT0_: argument 0"}
!218 = distinct !{!218, !"_ZN5boost3pfr6detail12my_tuple_catINS1_14sequence_tuple5tupleIJRN5eosio5assetEEEENS4_IJS7_RNS5_4nameEEEEEEDaRKT_RKT0_"}
!219 = distinct !{!219, !220, !"_ZN5boost3pfr6detail29make_flat_tuple_of_referencesIN5eosio5token14currency_statsENS1_19offset_based_getterIS5_NS1_14sequence_tuple5tupleIJNS3_5assetES9_NS3_4nameEEEEEELj0ELj3EEEDaRT_RKT0_NSt3__117integral_constantIjXT1_EEENSJ_IjXT2_EEE: argument 0"}
!220 = distinct !{!220, !"_ZN5boost3pfr6detail29make_flat_tuple_of_referencesIN5eosio5token14currency_statsENS1_19offset_based_getterIS5_NS1_14sequence_tuple5tupleIJNS3_5assetES9_NS3_4nameEEEEEELj0ELj3EEEDaRT_RKT0_NSt3__117integral_constantIjXT1_EEENSJ_IjXT2_EEE"}
!221 = distinct !{!221, !222, !"_ZN5boost3pfr6detail26tie_as_tuple_loophole_implIN5eosio5token14currency_statsEEEDaRT_: argument 0"}
!222 = distinct !{!222, !"_ZN5boost3pfr6detail26tie_as_tuple_loophole_implIN5eosio5token14currency_statsEEEDaRT_"}
!223 = !{!224, !14, i64 0}
!224 = !{!"_ZTSN5boost3pfr6detail14sequence_tuple16base_from_memberILj0ERN5eosio5assetEEE", !14, i64 0}
!225 = !{!226, !14, i64 0}
!226 = !{!"_ZTSZN5eosiorsINS_10datastreamIPKcEENS_5token14currency_statsELPv0EEERT_S9_RT0_EUlS9_E_", !14, i64 0}
!227 = !{!228, !14, i64 0}
!228 = !{!"_ZTSN5boost3pfr6detail14sequence_tuple16base_from_memberILj1ERN5eosio5assetEEE", !14, i64 0}
!229 = !{!230, !14, i64 0}
!230 = !{!"_ZTSN5boost3pfr6detail14sequence_tuple16base_from_memberILj2ERN5eosio4nameEEE", !14, i64 0}
!231 = !{!232, !14, i64 0}
!232 = !{!"_ZTSN5boost3pfr6detail14sequence_tuple16base_from_memberILj0ERKN5eosio5assetEEE", !14, i64 0}
!233 = !{!234, !14, i64 0}
!234 = !{!"_ZTSZN5eosiolsINS_10datastreamIPcEENS_5token14currency_statsELPv0EEERT_S8_RKT0_EUlRKS7_E_", !14, i64 0}
!235 = !{!236, !14, i64 0}
!236 = !{!"_ZTSN5boost3pfr6detail14sequence_tuple16base_from_memberILj1ERKN5eosio5assetEEE", !14, i64 0}
!237 = !{!238, !14, i64 0}
!238 = !{!"_ZTSN5boost3pfr6detail14sequence_tuple16base_from_memberILj2ERKN5eosio4nameEEE", !14, i64 0}
!239 = !{!240, !14, i64 0}
!240 = !{!"_ZTSNSt3__122__compressed_pair_elemIPN5eosio16permission_levelELi0ELb0EEE", !14, i64 0}
!241 = !{!242, !14, i64 0}
!242 = !{!"_ZTSNSt3__113__vector_baseIcNS_9allocatorIcEEEE", !14, i64 0, !14, i64 4, !243, i64 8}
!243 = !{!"_ZTSNSt3__117__compressed_pairIPcNS_9allocatorIcEEEE"}
!244 = !{!245}
!245 = distinct !{!245, !246, !"_ZN5eosio4packINSt3__15tupleIJNS_4nameES3_NS_5assetENS1_12basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEEEEEEENS1_6vectorIcS9_EERKT_: argument 0"}
!246 = distinct !{!246, !"_ZN5eosio4packINSt3__15tupleIJNS_4nameES3_NS_5assetENS1_12basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEEEEEEENS1_6vectorIcS9_EERKT_"}
!247 = !{!242, !14, i64 4}
!248 = !{!249, !14, i64 0}
!249 = !{!"_ZTSNSt3__122__compressed_pair_elemIPcLi0ELb0EEE", !14, i64 0}
!250 = !{!251}
!251 = distinct !{!251, !252, !"_ZN5eosio4packINS_6actionEEENSt3__16vectorIcNS2_9allocatorIcEEEERKT_: argument 0"}
!252 = distinct !{!252, !"_ZN5eosio4packINS_6actionEEENSt3__16vectorIcNS2_9allocatorIcEEEERKT_"}
!253 = !{!254, !14, i64 0}
!254 = !{!"_ZTSN5boost6fusion18std_tuple_iteratorIKNSt3__15tupleIJN5eosio4nameES5_NS4_5assetENS2_12basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEEEEELi0EEE", !14, i64 0}
!255 = !{!256, !14, i64 0}
!256 = !{!"_ZTSZN5eosiolsINS_10datastreamIPcEEJNS_4nameES4_NS_5assetENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEEEEERT_SE_RKNS6_5tupleIJDpT0_EEEEUlRKSD_E_", !14, i64 0}
!257 = !{!258}
!258 = distinct !{!258, !259, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE6rbeginEv: argument 0"}
!259 = distinct !{!259, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE6rbeginEv"}
!260 = !{!261}
!261 = distinct !{!261, !262, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE4rendEv: argument 0"}
!262 = distinct !{!262, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE4rendEv"}
!263 = !{!264}
!264 = distinct !{!264, !265, !"_ZNSt3__17find_ifINS_16reverse_iteratorINS_11__wrap_iterIPN5eosio11multi_indexILNS3_4name3rawE3607749779137757184ENS3_5token7accountEJEE8item_ptrEEEEEZNKS9_31load_object_by_primary_iteratorEiEUlRKSA_E_EET_SH_SH_T0_: argument 0"}
!265 = distinct !{!265, !"_ZNSt3__17find_ifINS_16reverse_iteratorINS_11__wrap_iterIPN5eosio11multi_indexILNS3_4name3rawE3607749779137757184ENS3_5token7accountEJEE8item_ptrEEEEEZNKS9_31load_object_by_primary_iteratorEiEUlRKSA_E_EET_SH_SH_T0_"}
!266 = !{!267}
!267 = distinct !{!267, !268, !"_ZNSt3__111make_uniqueIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE4itemEJPKS7_ZNKS7_31load_object_by_primary_iteratorEiEUlRT_E_EEENS_11__unique_ifISB_E15__unique_singleEDpOT0_: argument 0"}
!268 = distinct !{!268, !"_ZNSt3__111make_uniqueIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE4itemEJPKS7_ZNKS7_31load_object_by_primary_iteratorEiEUlRT_E_EEENS_11__unique_ifISB_E15__unique_singleEDpOT0_"}
!269 = !{!270, !14, i64 0}
!270 = !{!"_ZTSZN5eosio5token11add_balanceENS_4nameENS_5assetES1_E3$_5", !14, i64 0}
!271 = !{!179, !14, i64 4}
!272 = !{!273, !14, i64 0}
!273 = !{!"_ZTSZN5eosio5token4openENS_4nameERKNS_6symbolES1_E3$_6", !14, i64 0}
!274 = !{!179, !14, i64 8}
!275 = !{!276}
!276 = distinct !{!276, !277, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE6rbeginEv: argument 0"}
!277 = distinct !{!277, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE6rbeginEv"}
!278 = !{!279}
!279 = distinct !{!279, !280, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE4rendEv: argument 0"}
!280 = distinct !{!280, !"_ZNSt3__16vectorIN5eosio11multi_indexILNS1_4name3rawE3607749779137757184ENS1_5token7accountEJEE8item_ptrENS_9allocatorIS8_EEE4rendEv"}
!281 = !{!282}
!282 = distinct !{!282, !283, !"_ZNSt3__17find_ifINS_16reverse_iteratorINS_11__wrap_iterIPN5eosio11multi_indexILNS3_4name3rawE3607749779137757184ENS3_5token7accountEJEE8item_ptrEEEEEZNS9_5eraseERKS8_EUlRKSA_E_EET_SJ_SJ_T0_: argument 0"}
!283 = distinct !{!283, !"_ZNSt3__17find_ifINS_16reverse_iteratorINS_11__wrap_iterIPN5eosio11multi_indexILNS3_4name3rawE3607749779137757184ENS3_5token7accountEJEE8item_ptrEEEEEZNS9_5eraseERKS8_EUlRKSA_E_EET_SJ_SJ_T0_"}
!284 = !{!285, !14, i64 0}
!285 = !{!"_ZTSN5boost6fusion18std_tuple_iteratorINSt3__15tupleIJN5eosio4nameENS4_5assetEEEELi0EEE", !14, i64 0}
!286 = !{!287, !14, i64 0}
!287 = !{!"_ZTSZN5eosiorsINS_10datastreamIPKcEEJNS_4nameENS_5assetEEEERT_S8_RNSt3__15tupleIJDpT0_EEEEUlS8_E_", !14, i64 0}
!288 = !{i64 0, i64 4, !60, i64 4, i64 4, !60, i64 8, i64 4, !43, i64 0, i64 1, !76, i64 0, i64 1, !76, i64 1, i64 11, !76, i64 0, i64 12, !76}
!289 = !{!290, !14, i64 0}
!290 = !{!"_ZTSZN5eosio14execute_actionINS_5tokenEJNS_4nameENS_5assetENSt3__112basic_stringIcNS4_11char_traitsIcEENS4_9allocatorIcEEEEEEEbS2_S2_MT_FvDpT0_EEUlDpT_E_", !14, i64 0, !14, i64 4}
!291 = !{!290, !14, i64 4}
!292 = !{!293, !14, i64 0}
...
!296 = !{!297, !14, i64 0}
!297 = !{!"_ZTSZN5eosio14execute_actionINS_5tokenEJNS_4nameES2_NS_5assetENSt3__112basic_stringIcNS4_11char_traitsIcEENS4_9allocatorIcEEEEEEEbS2_S2_MT_FvDpT0_EEUlDpT_E_", !14, i64 0, !14, i64 4}
!298 = !{!297, !14, i64 4}
!299 = !{!300, !14, i64 0}
...
!307 = !{!308, !14, i64 0}
!308 = !{!"_ZTSZN5eosio14execute_actionINS_5tokenEJNS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEEEEbNS_4nameESA_MT_FvDpT0_EEUlDpT_E_", !14, i64 0, !14, i64 4}
!309 = !{!308, !14, i64 4}
