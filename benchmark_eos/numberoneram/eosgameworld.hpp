...
private:
    ...
    typedef singleton<N(number), st_number> tb_number;
    tb_number sgt_number;
    ...
    st_number get_number() {
        eosio_assert(sgt_number.exists(), "number not exist");
        return sgt_number.get();
    }
