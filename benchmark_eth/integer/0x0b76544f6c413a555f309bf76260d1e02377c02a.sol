...
contract token { /*Public variables of the token*/ string public name; string public symbol; uint8 public decimals; uint256 public totalSupply;
  ...
  function burn(uint256 _value) returns (bool success) {
      ...
      totalSupply -= _value;                                // Updates totalSupply // underflow
  ...
  function burnFrom(address _from, uint256 _value) returns (bool success) {
      ...
      totalSupply -= _value;                              // Update totalSupply // underflow
      Burn(_from, _value);
      return true;
  }
}
contract INTToken is owned, token {
  ...
  function sell(uint256 amount) {
      require(this.balance >= amount * sellPrice);      // checks if the contract has enough ether to buy // overflow
