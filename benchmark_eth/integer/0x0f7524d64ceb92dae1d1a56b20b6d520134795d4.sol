...
contract POWHClone {
	...
	function dividends(address _owner) public constant returns (uint256 amount) {
		return (uint256) ((int256)(earningsPerShare * balanceOfOld[_owner]) - payouts[_owner]) / PRECISION; // underflow
	}
	...
	function reserve() public constant returns (uint256 amount) {
		return balance()
			- ((uint256) ((int256) (earningsPerShare * totalSupply) - totalPayouts) / PRECISION) - 1; // underflow
	}
	...
	function buy() internal {
		...
		var payoutDiff = (int256) ((earningsPerShare * numTokens) - buyerfee); // underflow
	...
	function sell(uint256 amount) internal {
		...
		var payoutDiff = (int256) (earningsPerShare * amount + (numEthers * PRECISION)); // overflow  // overflow 
